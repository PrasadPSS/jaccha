    ...
    <div class="content-header row">
      <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h5 class="content-header-title float-left pr-1 mb-0">Fix COD Limit</h5>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <h4 class="card-title">Fix COD Limit</h4>
            </div>
            <div class="card-content">
              <div class="card-body">
                ...
                'method' => 'POST',
                'url' => ['admin/fakeordermanagement/update'],
                'class' => 'form'
                ]) !!}
                <div class="form-body">
                  <div class="row">
                    ...
                    {{ Form::hidden('fake_order_id', $order_cancel->fake_order_id) }}
