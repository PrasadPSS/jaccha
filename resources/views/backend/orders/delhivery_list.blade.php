...
<script type="text/javascript">
  ...
  function Popup(data)
  {
      ...
      mywindow.document.write('<table width="100%" class="data_table"><thead><tr><th colspan="9" class="thead_title"><img src="https://dadreeios.com/backend-assets/uploads/frontend_images/165337789455.png" style="position: fixed;left: 20px;top: 20px;"><h2>G.R. Parwani Trading Co.</h2><p style="font-size:14px">403, HARNAM APARTMENT, 4TH FLOOR, SECTION 30, VTC ROAD,<br/> NEAR GURUDWARA, ULHASNAGAR – 421004, THANE, MAHARASHTRA, INDIA</p><h3> Delhivery List</h3><h4 style="text-align:right;">Date: {{date("d/m/Y")}}</h4></th></tr><tr><th>#</th><th>PLACE OF SUPPLY</th><th>TRACKING NUMBER</th><th>TAX INVOICE NUMBER</th><th>TAX INVOICE DATE</th><th>BUYER\'S NAME</th><th>BUYER\'S CITY</th><th>AMOUNT</th><th>PAYMENT TYPE</th></tr></thead>');
