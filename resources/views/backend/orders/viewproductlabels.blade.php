                  ...
                  <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                      <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Package Labels
                        </li>
                      </ol>
                    </div>
                  </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                              <a href="{{ route('admin.orders') }}" class="btn btn-outline-secondary float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                                <h4 class="card-title">Product Label
                                </h4>
                            </div>
                                    ...
                                    <div class="row mb-3 tracker-details-row">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-8 ">
                                            <div class="delivery-product-info">
                                                ...
                                                @endif
                                                <p>
                                                    <span class="delivery-pro-color" style="padding-right:10px;"><b>Colour:</b> {{ $orderproducts->product_color }}</span>
                                                    <span class="delivery-pro-size" style="padding-right:10px"><b>Size:</b> {{ $orderproducts->product_size }}</span>
                                        ...
                                        <div class="card">
                                          <div class="card-header">
                                            <a href="javascript:void(0);" class="btn btn-outline-secondary float-right ml-1" onclick="PrintElem('.printinvoice_{{ $orderproducts->product_id }}');"><span class="align-middle ml-25">Print</span></a>
                                          </div>
                                          <div class="card-content print-card">
                                            <div class="card-body card-dashboard">
                                              @include('backend.orders.product_labels')
                                            </div>
                                          </div>
                                        </div>
                                    </div>
