                ...
                <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                  ...
                  <span style="font-size: 14px;">GSTIN : 2222222222</span><br>
                                    ...
                                    <td colspan="10"style="vertical-align: baseline;padding-top: 20px;text-align: end;" >
                                        ...
                                        <span style="font-size:14px;">{{ $shipping_address->shipping_full_name }},<br>
          {{ $shipping_address->shipping_address_line1 }},<br>
          {{ $shipping_address->shipping_address_line2 }},<br>
          {{ $shipping_address->shipping_city}}, {{ $shipping_address->shipping_state}}<br>
          Pincode - {{ $shipping_address->shipping_pincode}}<br>
          Mobile - {{ $shipping_address->shipping_mobile_no}}<br>
          <!-- Email - {{ $shipping_address->email}}<br> -->
        </span>
                                        {{--                                            <p style="font-size: 16px;margin-bottom: 0rem; font-weight: 500;">State/UT Code: {{ $shipping_address->shipping_state}} </p>--}}
                                        {{--                                            <p style="font-size: 16px;margin-bottom: 0rem; font-weight: 500;">Place of supply:{{ $shipping_address->shipping_landmark .', '.$shipping_address->shipping_address_line1 .', '. $shipping_address->shipping_district}}</p>--}}
                                        {{--                                            <p style="font-size: 16px;margin-bottom: 0rem; font-weight: 500;">Place of delivery:{{ $shipping_address->shipping_landmark .', '.$shipping_address->shipping_address_line1 .', '. $shipping_address->shipping_district}}</p>--}}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="10"style="vertical-align: baseline;padding: 10px 0px;text-align: end;" >
                                        ...
                                        <span style="font-size: 14px;"class="kt-invoice__text">{{ $shipping_address->shipping_full_name }},<br>
          {{ $shipping_address->shipping_address_line1 }},<br>
          {{ $shipping_address->shipping_address_line2 }},<br>
          {{ $shipping_address->shipping_city}}, {{ $shipping_address->shipping_state}}<br>
          Pincode - {{ $shipping_address->shipping_pincode}}<br>
