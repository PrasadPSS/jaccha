        ...
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="col-md-4 col-12">
                              <fieldset class="form-group">
                                <div class="input-group">
                                  ...
                                  {{ Form::select('order_return_status', ['0'=>'Returned','1'=>'Returned & Refunded'], null,['class'=>'select2 form-control ', 'placeholder' => 'Returning',]) }}
                                </div>
                              </fieldset>
                            </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Order is Cancelled @if(isset($orders->cancelreason) && $orders->cancelreason->for_dadreeios ==1) by Dadreeios @endif</h4>
                  </div>
                  <div class="card-content">
                    <div class="card-body">
