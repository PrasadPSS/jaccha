@if(isset($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]))
<div class="col-md-12 mt-4 printinvoice_{{ $orderproducts->product_id }} thermel-print">
  <table class="" style="width:100%;border:none !important;border-collapse:collapse;">
    ...
    <tr>
      <td colspan="3" style="width:50%;padding:4px 10px;border:1px solid #000;border-top:hidden;border-right:hidden">{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['rpin']) }}</td>
      <td colspan="3" style="width:50%;padding:4px 10px;border:1px solid #000;text-align:right;border-top:hidden;border-left:hidden">{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['sort_code']) }}</td>
    </tr>
    <tr>
      <td colspan="4" style="width:70%;border:1px solid #000; padding: 0 10px;">
      ...
      <td colspan="2" style="border:1px solid #000;text-align:center">
        ...
        @else
            <span style="font-size:17px;font-weight:600;">PREPAID<br></span>
            
        @endif
      </td>
    </tr>
    <tr>
      <td colspan="3" style="padding:4px 10px;border:1px solid #000;">
        Seller <br>Address:
      </td>
      <td colspan="3" style="padding:4px 10px;border:1px solid #000;"></td>
    </tr>
    <tr>
      <td colspan="3" style="padding:4px 10px;border:1px solid #000;">Product</td>
    ...
    <tr>
      <td colspan="3" style="padding:4px 10px;border:1px solid #000;">{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['prd']) }}</td>
    ...
    <tr>
      <td colspan="3" style="padding:4px 10px;border:1px solid #000;">Total</td>
      <td colspan="2" style="padding:4px 3px;border:1px solid #000;text-align:center">{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['rs']) }}</td>
      <td colspan="2" style="padding:4px 3px;border:1px solid #000;text-align:center">{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['rs']) }}</td>

    </tr>
    <tr>
      <td colspan="6" style="padding:6px 10px;border:1px solid #000;text-align:center">
        <img src="{{ html_entity_decode($package_slip_responses[$orderproducts->orders_product_details_id]['packages'][0]['oid_barcode']) }}" alt="">
      </td>
    </tr>
    <tr>
      <td colspan="6" style="padding:4px 10px;border:1px solid #000;">
        Return Address:
      </td>
    </tr>
  </table>
