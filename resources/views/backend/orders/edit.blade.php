                        ...
                        <div class="row">
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                              ...
                              {{ Form::label('gst_name', 'Color Name *') }}
                              {{ Form::text('gst_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Color Name', 'required' => true]) }}
                            </div>
                          </div>
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                              {{ Form::label('gst_percent', 'Color Percent *') }}
                              {{ Form::number('gst_percent', null, ['class' => 'form-control', 'placeholder' => 'Enter Color Percent', 'required' => true,'min'=>1]) }}
                            </div>
                          </div>
