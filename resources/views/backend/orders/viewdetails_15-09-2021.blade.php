...
@section('content')
                ...
                <div class="col-md-12 col-12 mt-2 menu_permissions">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-inline-block mr-2 mb-1">
                      <fieldset>
                        <div class="checkbox checkbox-primary">
                          {{ Form::checkbox('confirmed_stage', 1, $orders->confirmed_stage, ['id'=>'confirmed_stage']) }}
                    ...
                    <li class="d-inline-block mr-2 mb-1">
                      <fieldset>
                        <div class="checkbox checkbox-primary">
                          {{ Form::checkbox('preparing_order_stage', 1, $orders->preparing_order_stage, ['id'=>'preparing_order_stage']) }}
                    ...
                    <li class="d-inline-block mr-2 mb-1">
                      <fieldset>
                        <div class="checkbox checkbox-primary">
                          {{ Form::checkbox('shipped_stage', 1, $orders->shipped_stage, ['id'=>'shipped_stage']) }}
                    ...
                    <li class="d-inline-block mr-2 mb-1">
                      <fieldset>
                        <div class="checkbox checkbox-primary">
                          {{ Form::checkbox('out_for_delivery_stage', 1, $orders->out_for_delivery_stage, ['id'=>'out_for_delivery_stage']) }}
                    ...
                    <li class="d-inline-block mr-2 mb-1">
                      <fieldset>
                        <div class="checkbox checkbox-primary">
                          {{ Form::checkbox('delivered_stage', 1, $orders->delivered_stage, ['id'=>'delivered_stage']) }}
  ...
  @if(isset($payment_details) && isset($orders) && $orders->payment_mode=='cod')
  <div class="col-12">
    <div class="card">
      <div class="card-header">
