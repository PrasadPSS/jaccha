...
<div class="col-md-12 mt-4 printinvoice_{{ $orderproducts->product_id }} thermel-print">
  <table class="" style="width:100%;border:3px solid #7d7c7c !important;padding:10px 10px 10px 10px !important;border-collapse:collapse;">
    ...
    <tr>
      <td colspan="2" style="border:none;padding:10px 10px 0px 10px; font-weight: 500;">M.R.P.: Rs. {{ ($orderproducts->product_discounted_price) }} (Inclusive of all taxes)</td>
    </tr>
    <tr>
      <td colspan="" style="border:none;padding:0px 0px 0px 10px;font-weight: 500;width:40%; ">SIZE: {{ ($orderproducts->product_size) }}</td>
      <td colspan="" style="border:none;font-weight: 500;padding:0px 10px 10px 10px;width:60%; ">COLOR: {{ ($orderproducts->product_color) }}</td>
    </tr>
    <tr>
      <td colspan="" style="border:none;padding:0px 0px 0px 10px;width:40%;font-weight: 500; ">QTY.: {{ ($orderproducts->qty) }}No.</td>
      <td colspan="" style="border:none;padding:0px 10px 10px 10px;width:60%;font-weight: 500; ">PKD.: {{ date("Y-m-d", strtotime($orders->preparing_order_date)) }}</td>
    </tr>
    <tr>
