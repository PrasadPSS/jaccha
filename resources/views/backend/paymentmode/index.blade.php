      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Payment Mode</h5>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb p-0 mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active">Payment Mode
                    </li>
                  </ol>
                </div>
              </div>
                                ...
                                <tbody>
                                  @if(isset($paymentmodes) && count($paymentmodes)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ strtoupper($paymentmode->payment_mode_code) }}</td>
                                      <td>{{ $paymentmode->status==1?'Active':'InActive' }}</td>
                                      <td>{{ $paymentmode->priority }}</td>
                                      <td>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <a href="{{ url('admin/paymentmode/edit/'.$paymentmode->payment_mode_id) }}" class="btn btn-primary"><i class="bx bx-pencil"></i></a>
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                        {!! Form::open([
                                            'method'=>'GET',
                                            'url' => ['admin/paymentmode/delete', $paymentmode->payment_mode_id],
