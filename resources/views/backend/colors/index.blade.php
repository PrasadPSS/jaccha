                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                      <div class="col-12 text-right">
                        <a href="{{ route('admin.colors.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add </a>
                      </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        @if(isset($color) && $color->color_type == 'multi')
                                          <img height="25" width="25" src="{{ asset('backend-assets/uploads/color_code/'.$color->color_code) }}" alt="Color">
                                        @else 
                                          <span style="background-color: {{ $color->color_code }}; border: 1px solid black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        @endif
                                      </td>
                                      <td>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <a href="{{ url('admin/colors/edit/'.$color->color_id) }}" class="btn btn-primary"><i class="bx bx-pencil"></i></a>
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                        {!! Form::open([
                                            'method'=>'GET',
                                            'url' => ['admin/colors/delete', $color->color_id],
