    ...
    <section id="basic-datatable">
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-content">
              <div class="card-body card-dashboard">
                <div class="col-12 text-right">
                  <a href="{{ route('admin.categories.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i>
                    Add </a>
                </div>
          ...
          @endphp
                  <a href="{{ url('admin/subcategories/category/' . $category->category_id) }}"
                  class="btn btn-primary btn-xs">Sub Categories</a>
                  @php
          }
          @endphp
