                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                      <div class="col-12 text-right">
                        <a href="{{ route('admin.orders.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add </a>
                      </div>
                                ...
                                <tbody>
                                  @if(isset($orders) && count($orders)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ $order->status }}</td>
                                      <td>
                                        <a href="{{ url('admin/orders/' . $order->order_id) }}" class="btn btn-primary"><i class="bx bx-eye"></i>View</a>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <!-- <a href="{{ url('admin/orders/edit/'.$order->order_id) }}" class="btn btn-primary"><i class="bx bx-pencil"></i></a> -->
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                        {!! Form::open([
                                            'method'=>'GET',
                                            'url' => ['admin/orders/delete', $order->order_id],
