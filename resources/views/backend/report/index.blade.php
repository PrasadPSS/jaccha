                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="form-control" name="report_type"
                                                                ...
                                                                <option value="Orders" {{ isset($report_type) &&
                                                                    $report_type=='Orders' ? 'selected' : '' }}>
                                                                    Orders</option>
                                                                <option value="Users" {{ isset($report_type) &&
                                                                    $report_type=='Users' ? 'selected' : '' }}>
                                                                    Users</option>
                                                                <option value="Payments" {{ isset($report_type) &&
                                                                    $report_type=='Payments' ? 'selected' : '' }}>
                                                                    Payments</option>
                                                                <option value="sales" {{ isset($report_type) &&
                                                                    $report_type=='sales' ? 'selected' : '' }}>
                                                                    Sales</option>
                                                                <option value="stock" {{ isset($report_type) &&
                                                                    $report_type=='stock' ? 'selected' : '' }}>
                                                                    Stock</option>
                                                                <option value="salescancelation" {{ isset($report_type)
                                                                    && $report_type=='salescancelation' ? 'selected'
                                                                    : '' }}>
                                                                    Sales Canceled</option>
                                                                <option value="returnorder" {{ isset($report_type) &&
                                                                    $report_type=='returnorder' ? 'selected' : '' }}>
                                                                    Return Order</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="date" name="start_date" class="form-control"
                                                                id="start_date"
                                                                value="<?php 
                                                                    echo !empty($_GET['start_date'])? $_GET['start_date']:"";
                                                                     ?>" required>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <h5>End Date</h5>
                                                            <input type="date" name="end_date" class="form-control"
                                                                id="end_date" value="<?php 
                                                                    echo !empty($_GET['end_date'])? $_GET['end_date']:"";
                                                                     ?>" required>
                                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="col-12  text-right">
                            <a href="{{ url('admin/report/orders/excel/' . $start_date . '/' . $end_date) }} "
                                class="btn btn-primary d-none">Export</a>
                        </div>
                        <div class="card-content">
                                    ...
                                    <table class="table zero-configuration" id="tbl-datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{($user->verified_mobile_no == '1') ? 'Verified':'Not Verified'}}
                                                </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table zero-configuration" id="tbl-datatable">
                                        ...
                                        <tbody>
                                            ...
                                            @if (isset($sales_cancel->orderproducts) &&
                                            count($sales_cancel->orderproducts) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ isset($sales_cancel->customer_name) ?
                                                    $sales_cancel->customer_name : '' }}
                                                </td>
                                                ...
                                                <td>{{ isset($sales_cancel->invoice_counter_id) ?
                                                    $sales_cancel->invoice_counter_id : '' }}
                                                </td>
                                                <td>
                                                ...
                                                <td>{{ isset($sales_cancel->discount_percent) ?
                                                    $sales_cancel->discount_percent : '' }}
                                                </td>
                                                <td>{{ isset($sales_cancel->order_product_discount_amount) ?
                                                    $sales_cancel->order_product_discount_amount : '' }}
                                                </td>
                                                <td>
                                                    {{ isset($sales_cancel->order_product_taxable_amount) ?
                                                    $sales_cancel->order_product_taxable_amount : '' }}
                                                </td>

                                                <td>{{ isset($orderproduct->gst_cgst_rate) ?
                                                    $orderproduct->gst_cgst_rate : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_cgst_amount) ?
                                                    $orderproduct->gst_cgst_amount : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_sgst_rate) ?
                                                    $orderproduct->gst_sgst_rate : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_sgst_amount) ?
                                                    $orderproduct->gst_sgst_amount : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_igst_rate) ?
                                                    $orderproduct->gst_igst_rate : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_igst_amount) ?
                                                    $orderproduct->gst_igst_amount : '' }}
                                                </td>
                                    ...
                                    <table class="table zero-configuration" id="tbl-datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ isset($return->order_product_discount_amount) ?
                                                    $return->order_product_discount_amount : '' }}
                                                </td>
                                                <td>
                                                    {{ isset($return->order_product_taxable_amount) ?
                                                    $return->order_product_taxable_amount : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_cgst_rate) ?
                                                    $orderproduct->gst_cgst_rate : '' }}
                                                </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table zero-configuration table-bordered" id="tbl-datatable">
                                        ...
                                        <tbody>
                                            ...
                                            @if (isset($report_result->orderproducts) &&
                                            count($report_result->orderproducts) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ isset($orderproduct->product_price) ?
                                                    $orderproduct->product_price : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->rev_sell_price) ?
                                                    $orderproduct->rev_sell_price : '' }}
                                                </td>
                                                <td>
                                                    {{ isset($orderproduct->product_discount) ?
                                                    $orderproduct->product_discount : 0 }}
                                                    ({{ isset($orderproduct->product_discount_type) ?
                                                    $orderproduct->product_discount_type : '' }})
                                                </td>
                                                <td>{{ isset($orderproduct->product_discounted_amount) ?
                                                    $orderproduct->product_discounted_amount : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->rev_discount) ? $orderproduct->rev_discount
                                                    : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->rev_taxable_amount) ?
                                                    $orderproduct->rev_taxable_amount : '' }}
                                                </td>
                                                <td>{{ isset($orderproduct->gst_cgst_rate) ?
                                                    $orderproduct->gst_cgst_rate : '' }}
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $report_result->shipping_state }}</td>
                                                <td>0</td>
                                                <td>{{ isset($report_result->cod_collection_charge) ?
                                                    $report_result->cod_collection_charge : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_collection_charge) ?
                                                    $report_result->cod_collection_charge : '0.00' }}
                                                </td>
                                                ...
                                                <td>{{ isset($report_result->cod_cgst_percent) ?
                                                    $report_result->cod_cgst_percent : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_cgst_amount) ?
                                                    $report_result->cod_cgst_amount : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_sgst_percent) ?
                                                    $report_result->cod_sgst_percent : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_sgst_amount) ?
                                                    $report_result->cod_sgst_amount : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_igst_percent) ?
                                                    $report_result->cod_igst_percent : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_igst_amount) ?
                                                    $report_result->cod_igst_amount : '0.00' }}
                                                </td>
                                                <td>{{ isset($report_result->cod_collection_charge_amount) ?
                                                    $report_result->cod_collection_charge_amount : '0.00' }}
                                                </td>
                                            </tr>
                                            @php $srno++; @endphp
                                            @endif
                                            ...
                                            <tr class="" style="font-weight: bold;">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td>{{ $report_results->sum('order_product_discount_amount') > 0 ?
                                                    round($report_results->sum('order_product_discount_amount'), 2) : 0
                                                    }}
                                                </td>
                                                <td>
                                                    {{ $report_results->sum('order_product_taxable_amount') > 0 ?
                                                    ($report_results->sum('cod_collection_charge') > 0 ?
                                                    round($report_results->sum('order_product_taxable_amount') +
                                                    $report_results->sum('cod_collection_charge'), 2) :
                                                    round($report_results->sum('order_product_taxable_amount'), 2)) : 0
                                                    }}
                                                </td>
                                                <td></td>
                                                <td>
                                                    {{ $report_results->sum('order_product_gst_cgst_amt') > 0 ?
                                                    ($report_results->sum('cod_cgst_amount') > 0 ?
                                                    round($report_results->sum('order_product_gst_cgst_amt') +
                                                    $report_results->sum('cod_cgst_amount'), 2) :
                                                    round($report_results->sum('order_product_gst_cgst_amt'), 2)) : 0 }}
                                                </td>
                                                <td></td>
                                                <td>
                                                    {{ $report_results->sum('order_product_gst_sgst_amt') > 0 ?
                                                    ($report_results->sum('cod_sgst_amount') > 0 ?
                                                    round($report_results->sum('order_product_gst_sgst_amt') +
                                                    $report_results->sum('cod_sgst_amount'), 2) :
                                                    round($report_results->sum('order_product_gst_cgst_amt'), 2)) : 0 }}
                                                </td>
                                                <td></td>
                                                <td>
                                                    {{ $report_results->sum('order_product_gst_igst_amt') > 0 ?
                                                    ($report_results->sum('cod_igst_amount') > 0 ?
                                                    round($report_results->sum('order_product_gst_igst_amt') +
                                                    $report_results->sum('cod_igst_amount'), 2) :
                                                    round($report_results->sum('order_product_gst_cgst_amt'), 2)) : 0 }}
                                                </td>
                                                <td>{{ $report_results->sum('total') > 0 ?
                                                    round($report_results->sum('total'), 2) : 0 }}
                                                </td>
                                            </tr>
                                            @endif
                                        </tbody>
...
var title = document.querySelector("#basic-datatable .card-title").textContent;
const urlParams = new URLSearchParams(window.location.search);
const start_date = urlParams.get('start_date');
const end_date = urlParams.get('end_date');
if(start_date != '' && end_date!=''){
    var condtion_date = " (From "+start_date+" To " + end_date +")";
}else{
    var condtion_date = "";
}
...
// alert(start_date);
            ...
            $('#tbl-datatable').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'csv',
                        messageTop:title+condtion_date,
                        title: title+condtion_date,
                        footer: false,
                        exportOptions: {
                            paging: false,                     
