                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 col-12 mt-1 mb-1">
                            <div class="custom-control custom-switch custom-control-inline mb-1">
                              <span><b>For Dadreeios</b></span>
                              <input type="checkbox" class="custom-control-input" id="for_dadreeios" name="for_dadreeios" value="1" {{ ($order_cancel->for_dadreeios==1)?'checked':'' }}>
                              <label class="custom-control-label ml-1" for="for_dadreeios">
                              </label>
                            </div>
                          </div>
