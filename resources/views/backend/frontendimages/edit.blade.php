...
@section('title', 'Edit Frontend Images')
      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Edit Frontend Images</h5>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{ route('admin.frontendimages') }}" class="btn btn-outline-secondary mr-1 mb-1 float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                  <h4 class="card-title">Edit Frontend Images</h4>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    @include('backend.includes.errors')
                    {!! Form::model($frontendimages, [
                        'method' => 'POST',
                        'url' => ['admin/frontendimages/update'],
                        'class' => 'form',
                        ...
                        <div class="row">
                          <div class="col-md-12 col-12">
                            <div class="form-group">
                              {{ Form::hidden('frontend_image_id', $frontendimages->frontend_image_id) }}
                              {{ Form::label('image_url', $frontendimages->image_name.' *') }}
                          ...
                          @if(($frontendimages->image_code == 'login') || ($frontendimages->image_code == 'signup'))
                            <div class="col-md-12 col-12">
                              <div class="form-group">
                          ...
                          @endif
                          @if(isset($frontendimages->image_url))
                            <div class="col-xl-3 col-md-3 img-top-card">
                              <div class="card widget-img-top">
                                <div class="card-content">
                                  <img class="card-img-top img-fluid mb-1" src="{{ asset('backend-assets/uploads/frontend_images/') }}/{{ $frontendimages->image_url }}" alt="{{$frontendimages->image_name}} Image">
                                </div>
                              </div>
                            </div>
                          @endif
