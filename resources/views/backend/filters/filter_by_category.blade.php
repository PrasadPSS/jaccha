...
@section('title', 'Filter Categories')
      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Filter Categories</h5>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb p-0 mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active">Filter Categories
                    </li>
                  </ol>
                </div>
              </div>
                                  ...
                                  @if(isset($categories) && count($categories)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <a href="{{ url('admin/filters/'.$category->category_id) }}" class="btn btn-primary"><i class="bx bx-search"></i></a>
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                      </td>
                                    </tr>
