            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{ route('admin.filterscategorylist',$category_id) }}" class="btn btn-outline-secondary float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                          ...
                          <div class="col-md-6 col-12">
                            <fieldset class="form-group">
                              <div class="input-group">
                                ...
                                {{ Form::select('category_id', $categories, $category_id,['class'=>'select2 form-control category', 'placeholder' => 'Please Select Category',]) }}
                              </div>
                            </fieldset>
                          </div>
