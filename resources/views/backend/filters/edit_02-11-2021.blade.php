                          ...
                          <div class="col-md-6 col-12">
                            <fieldset class="form-group">
                              <div class="input-group">
                                ...
                                {{ Form::select('category_id', $categories, $filter->category_id,['class'=>'select2 form-control category', 'placeholder' => 'Please Select Category',]) }}
                              </div>
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-12">
                            <fieldset class="form-group">
                              <div class="input-group">
                                ...
                                {{ Form::select('sub_category_id', $sub_categories, $filter->sub_category_id,['class'=>'select2 form-control subcategory', 'placeholder' => 'Please Select Sub Category',]) }}
                              </div>
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-12">
                            <fieldset class="form-group">
                              <div class="input-group">
                                ...
                                {{ Form::select('sub_sub_category_id', $sub_sub_categories, $filter->sub_sub_category_id,['class'=>'select2 form-control subsubcategory', 'placeholder' => 'Please Select Child Category',]) }}
                              </div>
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-12">
