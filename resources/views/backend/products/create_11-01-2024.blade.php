                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 col-12">
                              <div class="custom-control custom-switch custom-control-inline mb-1">
                                ...
                                <input type="checkbox" class="custom-control-input" id="popularity" name="popularity" value="1" >
    ...
    <script>
      $(document).ready(function()
      {
        ...
        $("#config_color_id").change(function()
        {
          ...
          if(color_id !='' && product_type !='' && product_sku !='' && product_price !='' && product_discounted_price !='')
          {
            getproductvariants(color_id,size_id,product_type,product_sku,product_price,product_discounted_price);
          }
        });
        ...
        function getproductvariants(color_id,size_id,product_type,product_sku,product_price,product_discounted_price)
        {
          if (product_type == 'configurable')
          {
            $.ajax({
                ...
                data:
                {
                  color_id: color_id, size_id: size_id,product_type: product_type,product_discounted_price: product_discounted_price,
