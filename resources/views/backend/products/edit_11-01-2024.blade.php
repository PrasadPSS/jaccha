                                  ...
                                  @if(isset($product_variants) && count($product_variants)>0)
                                    @foreach($product_variants as $product_variant)
                                      <tr data-repeater-item>
                                        ...
                                        <td>
                                          <input type="text" name="added_variants[{{ $product_variant->product_variant_id }}][product_discounted_price]" class="form-control" value="{{ $product_variant->product_discounted_price }}" required>
                                        </td>
                                        <td>
                          ...
                          <div class="col-md-6 col-12">
                            ...
                            <div class="col-md-6 col-6">
                              ...
                              <fieldset class="form-group">
                                <div class="input-group">
                                  ...
                                  {!! Form::select('filter_id[]', $filter_list, $filter_values,['class'=>'select2 form-control ', 'multiple'=>'multiple','id'=>'filter_list']) !!}
                                </div>
                              </fieldset>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                              <div class="custom-control custom-switch custom-control-inline mb-1">
                                ...
                                <input type="checkbox" class="custom-control-input" id="popularity" name="popularity" value="1" {{ ($products->popularity==1)?'checked':'' }}>
                    ...
                    <div class="row mt-1">
                      <div class="col-md-12">
                        ...
                        @if(isset($product_images) && count($product_images)>0)
                          <button class="btn btn-danger float-right mb-2" id="delete_selected_images">Delete Selected <i class="bx bx-trash"></i></button>
                        @endif
                      </div>
                      @if(isset($product_images) && count($product_images)>0)
                        @foreach($product_images as $product_image_id => $image_name)
                          <div class="col-xl-3 col-md-3 img-top-card" id="remove_image_card_{{$product_image_id}}">
                            <div class="form-group checkbox checkbox-primary">
                              <input type="checkbox" id="select_product_image_{{$product_image_id}}" class="delete_product_images" name="product_image_id" value="{{$product_image_id}}" >
