                    ...
                    {{ Form::open(array('url' => 'admin/products/store','enctype' => 'multipart/form-data')) }}
                      <div class="form-body">
                        <div class="row">
                          ...
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                              {{ Form::label('product_hsn', 'Product HSN ') }}
                              {{ Form::text('product_hsn', null, ['class' => 'form-control', 'placeholder' => 'Enter Product HSN', 'required' => true,'id'=>'product_hsn']) }}
                            </div>
                          </div>
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-12">
                          ...
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                              {{ Form::label('product_delivery_estimate_days', 'Product Estimate Delivery Days ') }}
                              {{ Form::text('product_delivery_estimate_days', null, ['class' => 'form-control', 'placeholder' => 'Enter Product Estimate Delivery Days', ]) }}
                            </div>
                          </div>
