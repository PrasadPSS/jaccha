            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body py-1">
                        ...
                        <div class="text-muted line-ellipsis">Orders Pending</div>
                                                                                    ...
                                                                                    @if (isset($orderlist) && count($orderlist) > 0)
                                                                                        ...
                                                                                        @foreach ($orderlist as $orders)
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>{{ $orders->orders_counter_id }}</td>
                                                                                                <td>
                                                                                                    @php
                                                                                    ...
                                                                                    @if (isset($customerlist) && count($customerlist) > 0)
                                                                                                ...
                                                                                                @foreach ($customerlist as $customer)
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <a href="{{ url('admin/externalusers/editstatus/'.$customer->id) }}" class="btn btn-primary">View</a>
