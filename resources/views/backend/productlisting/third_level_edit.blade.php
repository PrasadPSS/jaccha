...
@section('title', 'Create Third Level Contents')
      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Update Third Level Contents</h5>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{ url('admin/productlisting/thirdlevel/'.$categories->subcategory_id) }}" class="btn btn-outline-secondary float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                  <h4 class="card-title">Update Contents for Third Level : {{ $categories->sub_subcategory_name }}</h4>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    ...
                    {!! Form::model($filters, [
                        'method' => 'POST',
                        'url' => ['admin/productlisting/thirdlevel/update'],
                        'class' => 'form'
                    ]) !!}
                      {{ csrf_field() }}
                      <div class="form-body">
