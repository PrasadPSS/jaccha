...
@section('title', 'Update Filter for Third Level')
      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Update Filter for Third Level</h5>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{ url('admin/filterassign/thirdlevel/'.$categories->subcategory_id) }}" class="btn btn-outline-secondary float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                  <h4 class="card-title">Update Filter for Third Level : {{ $categories->sub_subcategory_name }}</h4>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    ...
                    {!! Form::model($filters, [
                        'method' => 'POST',
                        'url' => ['admin/filterassign/thirdlevel/update'],
                        'class' => 'form'
                    ]) !!}
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-12 col-12">
                            <div class="form-group checkbox checkbox-primary">
                              ...
                              {{ Form::hidden('sub_category_id', $categories->subcategory_id) }}
                              {{ Form::hidden('sub_sub_category_id', $categories->sub_subcategory_id) }}
                                    ...
                                    <li class="d-inline-block mr-2 mb-1">
                                      <fieldset>
                                        <div class="checkbox checkbox-primary">
                                          ...
                                          {{ Form::label('filter_value_ids['.$filtervalue->filter_value_id.']', $filtervalue->filter_value) }} @if($filter->filter_type=='color') {{isset($colors[$filtervalue->filter_value])?'('.$colors[$filtervalue->filter_value].')':''}}@endif
                                        </div>
                                      </fieldset>
                                    </li>
                                    @endforeach
