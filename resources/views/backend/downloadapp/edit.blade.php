                          ...
                          @if(isset($downloadapp_image->image_url))
                            <div class="col-xl-3 col-md-3 img-top-card">
                              <div class="card widget-img-top">
                                <div class="card-content">
                                  <img class="card-img-top img-fluid mb-1" src="{{ asset('backend-assets/uploads/downloadapp_image/') }}/{{ $downloadapp_image->image_url }}" alt="{{$downloadapp_image->image_name}} Image">
                                </div>
                              </div>
                            </div>
                          @endif
