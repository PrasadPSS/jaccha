...
@section('content')
                                ...
                                <div class="card-body">
                                                    ...
                                                    <div class="card widget-img-top">
                                                        <div class="card-content">
                                                            ...
                                                            <img class="card-img-top img-fluid mb-1"
                                                                src="{{ asset('backend-assets/uploads/product_variant_thumbs/') }}/{{ $products->product_thumb }}"
                                                                alt="Product Image">
                                                        </div>
                                    ...
                                    @if (isset($product_images) && count($product_images) > 0)
                                        <div class="col-md-12">
                                            ...
                                            <span class="btn btn-danger float-right mb-2" id="delete_selected_images">Delete
                                                Selected <i class="bx bx-trash"></i></span>
                                        </div>

                                        <div class="form-group checkbox checkbox-primary">
                                            <input type="checkbox" id="select_all_images" class="select-all-images">
                                            <label for="select_all_images">Select All</label>
                                        </div>
                                        <div class="row mt-1">
                                                ...
                                                <div class="col-xl-3 col-md-3 img-top-card"
                                                    ...
                                                    <div class="form-group checkbox checkbox-primary">
                                                        <input type="checkbox"
                                                            ...
                                                            class="delete_images" name="image"
                                                            value="{{ $product_image_id }}">
                                                        <label for="select_product_image_{{ $product_image_id }}"></label>
                                                    </div>
                                                    <div class="card widget-img-top">
                                                        <div class="card-content">
                                                            <img class="card-img-top img-fluid mb-1"
                                                                src="{{ asset('backend-assets/uploads/product_variant_images/') }}/{{ $image_name }}"
                                                                alt="Product Image">
                                                        </div>
    ...
    <div class="modal fade" id="image_delete_toast" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            var myModal = new bootstrap.Modal(document.getElementById('image_delete_toast'));
            $('#delete_selected_images').on('click', function() {
                // $('#onshow').removeData();

                var image_ids = [];
                $('input[name="image"]:checked').each(function(index) {
                    image_ids[index] = this.value;
                });
                ...
                if (image_ids != '') {
                    ...
                    var confirm_result = confirm('Are you sure you want to Delete this Images ?');
                    if (!confirm_result) {
                        return true;
                    }
                    $.ajax({
                        url: '{{ url('admin/productvariants/delete/all_images') }}',
                        type: 'POST',
                        data: {
                            // id:,
                            image_ids: image_ids,
                        ...
                        success: function(data) {
                            ...
                            if (data.flag == true) {
                                $.each(image_ids, function(key, val_ids) {
                    ...
                    $('#delete_image_toast_content').text('Please Select Images To Delete');
                    $('#image_delete_toast').modal('show');
                }
            ...
            $(function() {
                ...
                $('#select_all_images').click(function() {
                    if ($(this).prop('checked')) {
                        $('.delete_images').prop('checked', true);
                    } else {
                        $('.delete_images').prop('checked', false);
                    }
                });
