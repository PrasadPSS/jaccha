  ...
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}">
        @if(isset(Logo::first()->logo_path))
          <div class="brand-logo"><img class="logo" src="{{ asset('assets/images/'. Logo::first()->logo_path) }}"/></div>
        @else
          <h2 class="brand-text mb-0">Jaccha</h2></a></li>
        @endif
