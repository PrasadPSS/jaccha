...
@section('title', 'Meta Home Management')
    ...
    <div class="content-header row">
      <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h5 class="content-header-title float-left pr-1 mb-0">Meta Home Management</h5>
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb p-0 mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}"><i class="bx bx-home-alt"></i></a>
                </li>
                <li class="breadcrumb-item active">Meta Home Management
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Meta Home Management</h4>
            </div>
            <div class="card-content">
              <div class="card-body card-dashboard">
                <div class="col-12 text-right">
                   <!-- <a href="{{ route('admin.metamanage.create') }}" class="btn btn-primary"><i
                ...
                <div class="table-responsive">
                  <table class="table zero-configuration table-responsive" id="tbl-datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $srno }}</td>
                        <td>{{ $order_cancel->page_name }}</td>
                        <td>{{ $order_cancel->meta_title }}</td>
                        <td>{{ $order_cancel->meta_desc }}</td>
                        <td>{{ $order_cancel->meta_keywords }}</td>
                        <td>{{ $order_cancel->og_title }}</td>
                        <td>{{ $order_cancel->og_desc }}</td>
       
                        <td>
                          <!-- @can('Update') -->
                          <!-- @endcan -->
                          <a href="{{ url('admin/metamanage/edit/'.$order_cancel->meta_id ) }}"
                            class="btn btn-primary"><i class="bx bx-pencil"></i></a>
                          <!-- @can('Delete') -->
                          <!-- @endcan -->
                          {!! Form::open([
                          'method'=>'GET',
                          'url' => ['admin/metamanage/delete', $order_cancel->meta_id ],
