                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 col-12">
                            <div class="form-group">
                              ...
                              {{ Form::text('filter_min_value', null, ['class' => 'form-control', 'placeholder' => 'Enter Filter Min Value', 'required' => false]) }}
                            </div>
                          </div>
                          <div class="col-md-4 col-12">
                            <div class="form-group">
                              {{ Form::label('filter_max_value', 'Filter Max Value') }}
                              {{ Form::text('filter_max_value', null, ['class' => 'form-control', 'placeholder' => 'Enter Filter Max Value', 'required' => false]) }}
                            </div>
                          </div>
                          @else
                          <div class="col-md-12 col-12">
