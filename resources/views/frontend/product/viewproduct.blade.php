...
@section('title', $product_details_title)
@section('metatags')
    <meta name="title" content="{{ $product->meta_title }}">
    <meta name="description" content="{{ $product->meta_desc }}">
    <meta name="keywords" content="{{ $product->meta_keywords }}">
    <link rel='canonical' href="{{ url()->current() }}" />
    <meta property="og:description" content="{{ $product->og_desc }}">
    ...
    <meta property="og:image"
        content="https://www.dadreeios.com/backend-assets/uploads/frontend_images/165337789455.png">
@endsection
@section('content')
    ...
    <!-- <div class="container">
                                                                                                                                                                                                                                    <img alt="dadreeios.com" class = "cloudzoom" src = "{{ asset('frontend-assets/images/small/image1.jpg') }}"
                                                                                                                                                                                                                                                 data-cloudzoom = "zoomImage: '{{ asset('frontend-assets/images/large/image1.jpg') }}'" />
                                                                                                                                                                                                                                            <br/>
                                                                                                                                                                                                                                    <img class = 'cloudzoom-gallery' src = "{{ asset('frontend-assets/images/thumbs/image1.jpg') }}" data-cloudzoom = "useZoom: '.cloudzoom', image: '{{ asset('frontend-assets/images/small/image1.jpg') }}', zoomImage: '{{ asset('frontend-assets/images/large/image1.jpg') }}' " >

                                                                                                                                                                                                                                    <img class = 'cloudzoom-gallery' src = "{{ asset('frontend-assets/images/thumbs/image2.jpg') }}" data-cloudzoom = "useZoom: '.cloudzoom', image: '{{ asset('frontend-assets/images/small/image2.jpg') }}', zoomImage: '{{ asset('frontend-assets/images/large/image2.jpg') }}' " >

                                                                                                                                                                                                                                    <img class = 'cloudzoom-gallery' src = "{{ asset('frontend-assets/images/thumbs/image3.jpg') }}" data-cloudzoom = "useZoom: '.cloudzoom', image: '{{ asset('frontend-assets/images/small/image3.jpg') }}', zoomImage: '{{ asset('frontend-assets/images/large/image3.jpg') }}' " >

                                                                                                                                                                                                                                    </div> -->


    <div class="container-fluidcustom pd-top top-padding sortyby-section">
                    ...
                    <div class="col-lg-7 ">
                        ...
                        <div id="carousel-thumb" class="carousel  carousel-fade carousel-thumbnails">
                            ...
                            <div class="carousel-inner" role="listbox" id="carousel_thumbs_div">
                                ...
                                @if (isset($product->product_images) && count($product->product_images) > 0 && !isset($product->product_variant_id))
                                    {{-- {{ dd($product->product_variant_id) }} --}}
                                        ...
                                        <div class="carousel-item {{ $slidcount == 0 ? 'active' : '' }}">
                                            <div class="wrapper">
                                                <div class="block">
                                                    ...
                                                    <img alt="dadreeios.com" id="cloudZoom" class="cloudzoom"
                                                        src="{{ asset('backend-assets/uploads/product_images_original/') }}/{{ $product_image->image_name }}"
                                                        data-cloudzoom="startMagnification: 8, minMagnification: 1, maxMagnification: 'auto', zoomSizeMode: 'lens',
                                ...
                                @if (isset($product->product_variant_images) &&
                                        count($product->product_variant_images) > 0 &&
                                        isset($product->product_variant_id))
                                    {{-- {{ dd('') }} --}}
                                    {{-- {{dd($product->product_variant_images)}} --}}
                                    @foreach ($product->product_variant_images->take(6) as $product_image)
                                        <div class="carousel-item {{ $slidcount == 0 ? 'active' : '' }}">
                                            <div class="wrapper">
                                                <div class="block">
                                                    <img alt="dadreeios.com" id="cloudZoom" class="cloudzoom"
                                                        src="{{ asset('backend-assets/uploads/product_variant_images_original/') }}/{{ $product_image->image_name }}"
                                                        data-cloudzoom="startMagnification: 8, minMagnification: 1, maxMagnification: 'auto', zoomSizeMode: 'lens',
                                                variableMagnification : false,
                                                lensWidth:100,
                                                lensHeight:100,
                    ...
                    <div class="col-lg-5  pl-0">
                        <div id="carousel-thumb" class="carousel  carousel-fade carousel-thumbnails">
                            <div class="produt-list" id="carousel_div">
                                ...
                                {{-- @if (isset($product->product_variant_images) && count($product->product_variant_images) > 0 && isset($product->product_variant_id))
                                    @foreach ($product->product_variant_images->take(6) as $product_image)
                                        @if ($thumbcount == 0)
                                        ...
                                        <li data-target="#carousel-thumb "
                                            class="{{ $thumbcount == 0 || $thumbcount == 3 ? 'image-mb' : '' }} {{ $thumbcount == 2 || $thumbcount == 5 ? 'image-mt' : '' }} img-li {{ $thumbcount == 0 ? 'active' : '' }}"
                                            data-slide-to="{{ $thumbcount }}">
                                            <img alt="dadreeios.com"
                                                class="img-fluid {{ $thumbcount == 0 ? 'active1' : '' }} img-hover-shadow lazy"
                                                src="{{ asset('backend-assets/uploads/product_variant_images_original/') }}/{{ $product_image->image_name }}">
                                        </li>
                ...
                <div class="row product-details-info">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        @if (isset($product->brands->brand_name))
                            <p id="product_sub_title"
                                style="margin-bottom: 0.5rem;color: #4f5362;font-size: 18px !important;">
                                {{ $product->brands->brand_name }}</p>
                        @else
                            &nbsp;
                        @endif
                        <h1 id="product_title">{{ $product->product_title }}</h1>
                        <p class="pro-price-details pro-price-details price-details-text mb-1">
                            @if ($product->product_discounted_price != null && $product->product_discount != 0)
                                <span id="product_discounted_price" class="price mr-2">₹
                                    {{ $product->product_discounted_price }}</span>
                                M.R.P. <span id="product_price" class="mrp-cut mr-2">₹
                            ...
                            @if (
                                ...
                                <span class="discount" id="discount_flat_per">({{ $product->product_discount }}%
                                    OFF)</span>
                                <span class="save-amount" id="save_amount">| You Save ₹
                                    {{ $product->product_price - $product->product_discounted_price }}</span>
                            @elseif(
                                $product->product_discount_type != null &&
                        ...
                        <p class="product-details-tax">Inclusive of all taxes</p>
                    </div>
                </div>


                <div class="row product-details-info pt-04">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <form class="color-size-selected" action="{{ url('/cart/addtocart') }}" method="post">
                            ...
                            <input type="hidden" name="product_type" id="product_type"
                                value="{{ !isset($product->product_variant_id) ? $product->product_type : 'configurable' }}">
                            <!-- color -->
                            <div class="produt-details-headings colors-option-padd">
                            ...
                            <div class="row swatches">
                                <div class="swatch clearfix" data-option-index="1">
                                    ...
                                    @if ($product->product_type == 'simple')
                                        <div data-value="{{ $product->color_id }}"
                                            class="swatch-element color blue available">

                                            <input quickbeam="color" id="color-{{ $product->color_id }}" type="radio"
                                                name="color_id" value="{{ $product->color_id }}" class="color_checked"
                                                checked required />
                                            <label for="color-{{ $product->color_id }}" style="border-color: #000;">
                                                @if (isset($product->color) && $product->color->color_type == 'multi')
                                                    <img alt="dadreeios.com" height="20" width="20"
                                                        style="margin: 0px 0px 0px 0px !important;"
                                                        src="{{ asset('backend-assets/uploads/color_code/') }}/{{ isset($color_list[$product->color_id]) ? $color_list[$product->color_id] : '' }}"
                                                        alt="Color">
                                                @else
                                                    <span
                                                        style="background-color: {{ isset($color_list[$product->color_id]) ? $color_list[$product->color_id] : '' }}; border: 1px solid black;"></span>
                                                @endif
                                        ...
                                        @if (isset($product->product_variants) && count($product->product_variants) > 0)
                                            ...
                                            @foreach ($product_color_ids as $color)
                                                ...
                                                <div data-value="{{ $color }}"
                                                    class="swatch-element color blue available">
                                                    <input quickbeam="color" id="color-{{ $color }}"
                                                        type="radio" name="color_id" value="{{ $color }}"
                                                        class="color_checked" {{ $loop->first ? 'checked' : '' }} />
                                                    <label for="color-{{ $color }}" style="border-color: #000;">

                                                        <span
                                                            style="background-color: {{ isset($color_list[$color]) ? $color_list[$color] : '' }};"></span>
                                                    </label>
                                                </div>
                                            @endforeach
                                        @endif
                            ...
                            <div class="row product-details-info ">
                                <div class="  col-sm-5 col-7">
                                    <div class="produt-details-headings colors-option-padd">
                                        <p class="p-0">SELECT SIZE <span class="left-product" id="product_qty">
                                ...
                                <div class="col-sm-7 col-5 view-sizechart-text">
                                        {{-- Added by Bishal on 2024-05-10 --}}
                                        @if(isset($size_chart) && $size_chart->visibility == 1)
                                            <a href="#" class="size-chart" data-toggle="modal" data-target="#myModal">
                                                <!-- VIEW SIZE CHART --> SIZE CHART
                                            </a>
                                        @endif
                                                                        ...
                                                                        <ul class="nav nav-tabs  nav-justified">
                                                                            <li class="nav-item">
                                                                                <a class="nav-link active" data-toggle="tab"
                                                                                    href="#sizechart-table-in">
                                                                                    <!-- Size Chart in Inch -->Size in Inches
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-toggle="tab"
                                                                                    href="#sizechart-table-cm">Size in Cms</a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-toggle="tab"
                                                                                    href="#sizechart-img">How to
                                                                                    Measure</a>
                                                                            </li>
                                                                        </ul>
                                                                        <!-- Tab panes -->
                                                                        <div class="tab-content">
                                                                            <div class="tab-pane container pt-3 active  pr-0 pl-0 contain-full"
                                                                                id="sizechart-table-in">
                                                                                <div class="table-responsive modal-size-chart">
                                                                                    <table
                                                                                        class="table table-hover sizechart-style table-bordered">
                                                                                        ...
                                                                                        <tbody>
                                                                                            @if (isset($size_chart->chart_childs) && count($size_chart->chart_childs) > 0)
                                                                                                ...
                                                                                                @foreach ($size_chart->chart_childs as $size_chart_child)
                                                                                                    <tr>
                                                                                                        @if (isset($size_chart_types))
                                                                                                            <td>{{ isset($size_chart_child->size->size_name) ? $size_chart_child->size->size_name : '' }}
                                                                                                            </td>
                                                                                                            @foreach ($size_chart_types as $size_chart_type)
                                                                                                                <td>{{ $size_chart_child->{$size_chart_type->size_chart_field_code} }}
                                                                                                                </td>
                                                                                                            @endforeach
                                                                                                        @endif
                                                                                                    </tr>
                                                                            ...
                                                                            <div class="tab-pane container text-center pt-3 pr-0 pl-0"
                                                                                id="sizechart-table-cm">
                                                                                <div class="table-responsive modal-size-chart">
                                                                                    <table
                                                                                        class="table table-hover sizechart-style table-bordered">
                                                                                        <thead class="thead-light">
                                                                                                ...
                                                                                                @foreach ($size_chart->chart_childs as $size_chart_child)
                                                                                                    <tr>
                                                                                                        @if (isset($size_chart_types))
                                                                                                            ...
                                                                                                            @foreach ($size_chart_types as $size_chart_type)
                                                                                                                <td>{{ isset($size_chart_child->{$size_chart_type->size_chart_field_code}) ? (is_numeric($size_chart_child->{$size_chart_type->size_chart_field_code}) ? $size_chart_child->{$size_chart_type->size_chart_field_code} * 2.54 : $size_chart_child->{$size_chart_type->size_chart_field_code}) : '-' }}
                                                                                                                </td>
                                                                                                            @endforeach
                                                                                                        @endif
                                                                                                    </tr>
                                                                            ...
                                                                            <div class="tab-pane container text-center fade"
                                                                                id="sizechart-img">
                                                                                @if (isset($size_chart->chart_images) && count($size_chart->chart_images) > 0)
                                                                                    @foreach ($size_chart->chart_images as $size_chart_image)
                                                                                        <img alt="dadreeios.com"
                                                                                            class="img-fluid mt-3  mb-3 lazy"
                                                                                            src="{{ asset('backend-assets/uploads/size_chart_images/') }}/{{ $size_chart_image->image_name }}"
                                                                                            alt="">
                                                                                    @endforeach
                                                                                @endif
                                                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                                    ...
                                                    <div class="swatch clearfix" data-option-index="0" id="sizes_div">
                                                        ...
                                                        @if ($product->product_type == 'simple')
                                                            ...
                                                            @if (isset($product->product_variant_id))
                                                                @if (isset($product->variant_combined_size) && count($product->variant_combined_size) > 0)
                                                                    @php
                                                                        $product_size = $product->load([
                                                                            'variant_combined_size' => function ($query) use ($product) {
                                                                                $query->where('product_variants.color_id', $product->color_id);
                                                                            },
                                                                        ]);
                                                                        // dd($product_size);

                                                                        $product_size_ids = array_unique(array_column($product->variant_combined_size->toArray(), 'size_id'));
                                                                        // dd($product_size_ids);
                                                                    @endphp
                                                                    @foreach ($product_size_ids as $size)
                                                                        <div data-value="{{ $size }}"
                                                                            class="swatch-element-size plain s available">
                                                                            <input id="size-{{ $size }}"
                                                                ...
                                                                @endif
                                                            @else
                                                                <div data-value="{{ $product->size_id }}"
                                                                    class="swatch-element-size plain s available">
                                                                    <input id="size-{{ $product->size_id }}"
                                                                        type="radio" name="size_id"
                                                                        value="{{ $product->size_id }}"
                                                                        class="size_checked" checked />
                                        ...
                                        @if ($errors->has('size_id'))
                                            ...
                                            <!-- </div> -->
                                        @endif
                                        <div class="error" id="empty_size_error" style="dislplay:none;">Please Select
                                            the Size</div>
                                    </div>
                            ...
                            <div class="row product-details-info pt-4">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="product-details-addbtn">
                                        ...
                                        <button type="submit" name="addto" class="pro-details-btn pro-add"
                                            value="addtocart">ADD TO
                                            CART</button>
                                        <button class="pro-like addtowishlist" type="button" name="button"><i
                                                class="fa fa-heart heart" aria-hidden="true"></i></button>
                                        <button type="submit" class="pro-details-btn  pro-buy" name="addto"
                                            value="addtobuy">BUY
                                            NOW</button>
    ...
    <div class="container-fluidcustom">
        <div class="row product-description-row">
                ...
                <div class="pro-details-tabs">
                    <nav class="pb-4">
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link mr-1 active" id="nav-description" data-toggle="tab"
                                href="#nav-description-tab" role="tab" aria-controls="nav-home"
                                aria-selected="true">DESCRIPTION</a>
                            <a class="nav-item nav-link mr-1" id="nav-specificatios" data-toggle="tab"
                                href="#nav-specificatios-tab" role="tab" aria-controls="nav-profile"
                                aria-selected="false">SPECIFICATIONS</a>
                            <a class="nav-item nav-link mr-1" id="nav-disclaimer" data-toggle="tab"
                                href="#nav-disclaimer-tab" role="tab" aria-controls="nav-contact"
                                aria-selected="false">DISCLAIMER</a>
                            <a class="nav-item nav-link" id="nav-rating" data-toggle="tab" href="#nav-rating-tab"
                                role="tab" aria-controls="nav-about" aria-selected="false">RATINGS & REVIEWS</a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-description-tab" role="tabpanel"
                            aria-labelledby="nav-description">
                            <div class="tab-content-color">
                                @if (isset($product->product_variant_id))
                                    <p class="tab-content-para">{!! $product->product->product_desc !!}</p>
                                @else
                        ...
                        @if (isset($product->product_variant_id))
                            <div class="tab-pane fade" id="nav-specificatios-tab" role="tabpanel"
                                aria-labelledby="nav-specificatios">

                                <div class="table-responsive specification-table">
                                    {!! $product->product->product_specification !!}
                                </div>
                                <div class="tab-content-color pt-4">
                                    <p><span class="tab-content-specificatios">Generic Name:</span> <span
                                            class="">{{ $product->product->product_generic_name }}</span><br>
                                        <span class="tab-content-specificatios">Product ID:</span> <span
                                            class="">{{ $product->product->product_sku }}</span><br>
                                        <span class="tab-content-specificatios">Country of Origin:</span> <span
                                            class="">{{ $product->product->country ? $product->product->country->name : 'NA' }}</span><br>
                                    </p>
                                    <p>
                                        <span class="tab-content-specificatios">Sold by: </span><span
                                            class="">{{ $product->product->seller ? $product->product->seller->seller_name : 'NA' }}</span><br>
                                    </p>
                                ...
                                <div id="text" class="tab-content-table more-info-bg pt-4">
                                    <p><span class="tab-content-details">Manufacturer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->product->manufacturer ? $product->product->manufacturer->manufacturer_name : 'NA' }}<br>
                                            {{ $product->product->manufacturer ? $product->product->manufacturer->manufacturer_address : 'NA' }}</span>
                                    </p>
                                    <p><span class="tab-content-details">Packer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->product->packer ? $product->product->packer->packer_name : 'NA' }}<br>
                                            {{ $product->product->packer ? $product->product->packer->packer_address : 'NA' }}</span>
                                    </p>
                                    <p><span class="tab-content-details">Importer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->product->importer ? $product->product->importer->importer_name : 'NA' }}<br>
                                            {{ $product->product->importer ? $product->product->importer->importer_address : 'NA' }}</span>
                                    </p>
                                </div>
                            </div>
                        @else
                            <div class="tab-pane fade" id="nav-specificatios-tab" role="tabpanel"
                                ...
                                <div class="tab-content-color pt-4">
                                    <p><span class="tab-content-specificatios">Generic Name:</span> <span
                                            class="">{{ $product->product_generic_name }}</span><br>
                                        <span class="tab-content-specificatios">Product ID:</span> <span
                                            class="">{{ $product->product_sku }}</span><br>
                                        <span class="tab-content-specificatios">Country of Origin:</span> <span
                                            class="">{{ $product->country ? $product->country->name : 'NA' }}</span><br>
                                    </p>
                                    <p>
                                        <span class="tab-content-specificatios">Sold by: </span><span
                                            class="">{{ $product->seller ? $product->seller->seller_name : 'NA' }}</span><br>
                                    </p>
                                    <span id="toggle" class="">View More Info</span>
                                </div>
                                <div id="text" class="tab-content-table more-info-bg pt-4">
                                    <p><span class="tab-content-details">Manufacturer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->manufacturer ? $product->manufacturer->manufacturer_name : 'NA' }}<br>
                                            {{ $product->manufacturer ? $product->manufacturer->manufacturer_address : 'NA' }}</span>
                                    </p>
                                    <p><span class="tab-content-details">Packer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->packer ? $product->packer->packer_name : 'NA' }}<br>
                                            {{ $product->packer ? $product->packer->packer_address : 'NA' }}</span>
                                    </p>
                                    <p><span class="tab-content-details">Importer Details</span><br>
                                        <span
                                            class="tab-content-subdetails">{{ $product->importer ? $product->importer->importer_name : 'NA' }}<br>
                                            {{ $product->importer ? $product->importer->importer_address : 'NA' }}</span>
                                    </p>
                                </div>
                            </div>
                        @endif
                        <div class="tab-pane fade" id="nav-disclaimer-tab" role="tabpanel"
                            aria-labelledby="nav-disclaimer">
                            <div class="tab-content-color">
                                @if (isset($product->product_variant_id))
                                    <p class="tab-content-para">{!! $product->product->product_disclaimer !!}</p>
                                @else
                        ...
                        <div class="tab-pane fade" id="nav-rating-tab" role="tabpanel" aria-labelledby="nav-rating">
                            <div class="product-details-rating">
                                <p class="rating-head">Customer Ratings & Reviews |
                                    @auth
                                        <a href="#" class="rating-star" data-toggle="modal"
                                            data-target="#reviewRating"> Write your
                                            Review for this Product <span><sup>Click</sup></span></a>
                                    </p>
                                @else
                                    <a href="{{ route('login') }}" class="rating-star"> Write your Review for this Product
                                        <span><sup>Click</sup></span></a></p>
                                @endauth
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row content-ratinng">
                                                        <div class="col-lg-2 col-md-2 col-sm-5 col-5">
                                                            <div class="produtct-rating-img">
                                                                @if (isset($product->product_variant_id))
                                                                    <img alt="dadreeios.com" class="img-fluid lazy"
                                                                        src="{{ asset('backend-assets/uploads/product_variant_thumbs/' . $product->product_thumb) }}"
                                                                        alt="Banner">
                                                                @else
                                                                    <img alt="dadreeios.com" class="img-fluid lazy"
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-sm-7 col-7">
                                                            <div class="product-rating-info">
                                                                ...
                                                                @if (isset($product->product_variant_id))
                                                                    <p>{{ $product->product->product_generic_name }}</p>
                                                                @else
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <form class="pt-4 rating-review-form"
                                                                action="{{ route('reviews') }}" method="post">
                                                                @csrf

                                                                <p>Rate This Product <span class="star">*</span></p>
                                                                ...
                                                                <div class="form-group m-0">
                                                                    <div class="form-item">
                                                                        <input id="rating-5" name="rating"
                                                                            type="radio" value="5" required>
                                                                        <label for="rating-5" data-value="5">
                                                                            <span class="rating-star">
                                                                                <span
                                                                                    class="ratingstar-hollow rating-star">&#9734;</span>
                                                                                <span
                                                                                    class="ratingstar-fill rating-star">&#9733;</span>
                                                                            </span>
                                                                            <!-- <span class="ir">5</span> -->
                                                                        </label>
                                                                        <input id="rating-4" name="rating"
                                                                ...
                                                                <p>Add your Key Headline<span class="star">*</span></p>
                                                                <div class="form-group  pb-2">
                                                                    <input class="form-control rating-input"
                                                                        name="headline" placeholder="Main Title"
                                                                        type="text" required>
                                                                </div>
                                                                <p>Write your Review and share your experience with other
                                                                    people<span class="star">*</span></p>
                                                                <div class="form-group pb-2">
                                    ...
                                    <div class="star-border">
                                        <div class="star-content">
                                            ...
                                            <div class="star-rating1">
                                                <p>{{ floor($avgrates) }} out of 5</p>
                                            </div>
                                        </div>
                                        <p style="padding-left: 20px;padding-right: 20px;text-align: center;">
                                            <span>{{ floor($avgrates) }}
                                            </span>Based <span>on {{ $countReviews }} Customer Reviews</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-7">
                            ...
                            <div class="row pt-4">
                                <div class="col-md-6 ">
                                    ...
                                    <div class="review">
                                        ...
                                        @else
                                            <div class="progress">
                                                <div class="progress-done" data-done="68"
                                                    style="width:{{ floor($percentage[5]) }}%;"></div>
                                            </div>
                                    ...
                                    <div class="review">
                                        ...
                                        @else
                                            <div class="progress">
                                                <div class="progress-done" data-done="68"
                                                    style="width:{{ floor($percentage[4]) }}%;"></div>
                                            </div>
                                    ...
                                    <div class="review">
                                        ...
                                        @else
                                            <div class="progress">
                                                <div class="progress-done" data-done="68"
                                                    style="width:{{ floor($percentage[3]) }}%;"></div>
                                            </div>
                                    ...
                                    <div class="review">
                                        ...
                                        @else
                                            <div class="progress">
                                                <div class="progress-done" data-done="68"
                                                    style="width:{{ floor($percentage[2]) }}%;"></div>
                                            </div>
                                    ...
                                    <div class="review">
                                        ...
                                        @else
                                            <div class="progress">
                                                <div class="progress-done" data-done="68"
                                                    style="width:{{ floor($percentage[1]) }}%;"></div>
                                            </div>
                            ...
                            <div class="row pt-4">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div class="all-ratings">
                                        ...
                                        <p>See All Ratings & Reviews ( {{ $countReviews }} )</p>
                                    </div>
                                    ...
                                    @if ($countReviews >= 2)
                                        <div class="review_bttn">
                                            <a
                                                href="{{ url('dp/') }}/{{ $product->category_slug }}/{{ $product->sub_category_slug }}/{{ $product->sub_sub_category_slug }}/{{ $product->product_slug }}/product-reviews">See
                                                All Reviews</a>
                                        </div>
                                    @endif
                                </div>
            ...
            <div class="col-lg-6 check-info-contennt">
                <div class="row product-details-infos">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="produt-details-headings colors-option-padd">
                        ...
                        <div class="subscribe_form pincode-form">
                            <div class="pincode-input" style="">
                                <div class="form-group  " style="margin-bottom: 5px;">
                                    <div class=" input-group">
                                        <input class="form-control form-control-h" id="shipping_pincode" type="text"
                                            maxlength="6" value="{{ old('shipping_pincode') }}" minlength="6"
                        ...
                        <div class="product-shortinfo">
                            <table>
                                <tr id="invalid_pincode" style="text-color: red;color: #C00000;">
                                    <td class="pr-2">
                                        <p class="m-0 text-center"><i class="fa fa-exclamation" aria-hidden="true"></i>
                                        </p>
                                    </td>
                                    <td>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="product-shortinfo product-policyinfo">
                            <p class="m-0 icons">Return & Refund Policy may vary based on Products, Promotions & Offers.
                                For more details, please refer our <a
                                    href="{{ url('/') }}/pages/return-refund-policy" class="return-policy"
                                    target="_blank">Return & Refund Policy</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row product-details-info no-top-padd pt-4">
                    <div class="col-md-12 col-12">
                        <div class="produt-details-headings colors-option-padd">
                            <p class="p-0">SHARE</p>
                        </div>
                        <div class="social-media-icon">
                            <a class="product-share fb" id="fb_share" href="#"><i class="fa fa-facebook"
                                    aria-hidden="true"></i></a>
                            <!--<a class="product-share insta" href="https://www.instagram.com/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>-->
                            <a class="product-share twit" id="twit_share" href="#"><i class="fa fa-twitter"
                                    aria-hidden="true"></i></a>
                            <!-- <a class="product-share pint" href="https://in.pinterest.com/" target="_blank"><i class="fa fa-pinterest" aria-hidden="true"></i></a> -->
                            <a class="product-share pint" id="pint_share" href="#">
                                <!-- (function()%7Bvar%20e=document.createElement('script');e.setAttribute('type','text/javascript');e.setAttribute('charset','UTF-8');e.setAttribute('src','http://assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e)%7D)() -->
                                <i class="fa fa-pinterest" aria-hidden="true"></i>
                            </a>
                            <a class="product-share whtsp" id="whatsapp_share" href="#"><i class="fa fa-whatsapp"
                                    aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
    ...
    @if(isset($product->product) && $product->product->product_type == 'configurable')
        @if (isset($relatedVariantProducts) && count($relatedVariantProducts) > 0)
            {{-- {{dd($variantImageList)}} --}}
            ...
            <div class="container-fluidcustom2 pt-4 ">
                <div class="row prodetails-head2 pt-4 ">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                        ...
                        <p class="ml-4 heading-border-bottom">You might prefer this</p>
                    </div>
                </div>
                ...
                <div class="row prodetails-head2 pt-4 pb-4">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="owl-carousel owl-theme product-slider1">
                            @php
                                $list_images = $variantImageList;
                            @endphp
                            @foreach ($relatedVariantProducts as $product_card)
                                @include(
                                    'frontend.product.details_product_card',
                                    compact('product_card', 'list_images'))
                            @endforeach
                            @php
                            // dd($list_images);
                                $list_images = [];
   ...
   @else
    ...
    @if (isset($frequently_boughts) && count($frequently_boughts) > 0)
        ...
        <div class="container-fluidcustom2 pt-4 mb-4">
            <div class="row prodetails-head2 pt-4 ">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <p class="ml-4 heading-border-bottom">Frequently bought together</p>
                </div>
            ...
            <div class="container-fluidcustom2 pt-4 pb-5 ">
                <div class="row prodetails-head2 pt-4 ">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-12 ">
                        <p class="ml-4 heading-border-bottom">Recently viewed </p>
                    </div>
                ...
                <div class="row prodetails-head2 pt-4 pb-4 mb-2">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="owl-carousel  owl-theme product-slider1">
                            @php
    ...
    <script>
            ...
            function variants(product_id, size_id, color_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data[1]['product_discounted_price'] != null && data[1][
                                'product_discount'
                            ] != 0 && data[1]['product_discount'] != null) {
                            $('#product_price').show();
                            $('#product_price').html('₹ ' + data[1]['product_price']);
                            $('#product_discounted_price').html('₹ ' + data[1][
                                'product_discounted_price'
                            ]);
                        } else if (data[1]['product_discounted_price'] != null && data[1][
                                'product_discount'
                            ] == 0 && data[1]['product_discount'] != null) {
                            $('#product_discounted_price').html('₹ ' + data[1][
                                'product_discounted_price'
                        ...
                        if (data[1]['product_discount_type'] != null && data[1][
                                'product_discount_type'
                            ] == 'percent' && data[1]['product_discount'] != 0 &&
                            data[1]['product_discount'] != null) {
                            $('#discount_flat_per').show();
                            $('#save_amount').show();
                            $('#discount_flat_per').html('(' + data[1]['product_discount'] + '% OFF)');
                            var disocunt_amount = data[1]['product_price'] - data[1][
                                'product_discounted_price'
                            ];
                            $('#save_amount').html('|   You Save ₹ ' + disocunt_amount);
                        } else if (data[1]['product_discount_type'] != null && data[1][
                                'product_discount_type'
                            ] == 'flat' && data[1]['product_discount'] != 0 && data[1][
                                'product_discount'
                            ] != null) {
                            $('#discount_flat_per').show();
                            $('#save_amount').show();
        ...
        $(document).ready(function() {
            ...
            var sharer_image = '';
            <?php
            if (isset($product->product_thumb) && $product->product_thumb != '') {
                echo "sharer_image = '" . asset('backend-assets/uploads/product_thumbs/') . '/' . $product->product_thumb . "';";
            } elseif (isset($product->product_images) && count($product->product_images) > 0) {
                foreach ($product->product_images->take(1) as $product_image) {
                    echo "sharer_image = '" . asset('backend-assets/uploads/product_images/') . '/' . $product_image->image_name . "';";
                }
            }
            ?>
            $('#pint_share').on('click', function() {
                ...
                window.open('http://pinterest.com/pin/create/button/?url=' + encodeURIComponent(u) +
                    '&description=' + encodeURIComponent(t) + '&media=' + encodeURIComponent(
                        sharer_image) + '', 'sharer', windowFeatures);
                return false;
            });
            $('#twit_share').on('click', function() {
                var u = window.location.href;
                var t = document.title;
                ...
                var windowFeatures = "status=no,height=" + height + ",width=" + width +
                    ...
                    leftPosition + ",screenY=" + topPosition +
                    ",toolbar=no,menubar=no,scrollbars=no,location=no,directories=no";
                window.open('http://twitter.com/share?url=' + encodeURIComponent(u) + '&text=' +
                    encodeURIComponent(t) + '&via=' + encodeURIComponent(siteurl) + '', 'sharer',
                    windowFeatures);
                return false;
            });
            $('#fb_share').on('click', function() {
                ...
                // sharePopup('https://www.facebook.com/dialog/share?app_id=' + MartJack.Config.AppId + '&display=popup&href=' + u + '&title=' + t + '&picture=' + sharer_image + '&description=' + d);
                window.open('https://www.facebook.com/dialog/share?app_id=795786888261296&href=' +
                    encodeURIComponent(u) + '&t=' + encodeURIComponent(t) + '&description=' +
                    encodeURIComponent(d) + '&picture=' + encodeURIComponent(sharer_image) + '',
            ...
            $('#whatsapp_share').on('click', function() {
                ...
                window.open('https://api.whatsapp.com/send?text=' + encodeURIComponent(u) + '', 'sharer',
                    windowFeatures);
                return false;
            });
        ...
        const lens = document.querySelector("body > div.cloudzoom-blank > div.cloudzoom-lens")
        const zoomImg = document.querySelector("#cloudZoom")
        console.log(lens, zoomImg)
