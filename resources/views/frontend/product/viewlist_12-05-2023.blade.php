...
<div class="container-fluidcustom top-padding ">
  ...
  <div class="row sortyby-section no-gutters sidebar-sortby">
    ...
    <div class="col-lg-10 col-sm-12 col-md-12 col-12 ">
      ...
      @else
      <h1 id="page_title_count">{!!$search!!}<span class="product-count" id="product-count"> ({{$product_count}})</span></h1>
      @endif
      @endif
    </div>
...
<div class="container-fluidcustom mb-5">
          ...
          <div class="col-md-5">
            ...
            <table class="table table-bordered " style="font-size:12px">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-danger"><a href="{{ url('dp/') }}/{{ $class->category_slug }}/{{ $class->sub_category_slug }}/{{ $class->sub_sub_category_slug }}/{{ $class->product_slug }}" target="_blank" style="color:#c00000;">{{$class->product_title}}</a></td>
...
<script>
  $(document).ready(function() {
    ...
    $('.addtowishlist').on('click', function() {
      auth = '{{Auth()->user()}}';
      if (!auth) {
        alert('Please login before adding product to your Wishlist !');
        return;
      }
