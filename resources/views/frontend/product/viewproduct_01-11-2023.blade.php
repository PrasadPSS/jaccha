                          ...
                          @if(isset($product->product_images) && count($product->product_images)>0)
                           @foreach($product->product_images->take(6) as $product_image)
                             <div class="carousel-item {{ ($slidcount==0)?'active':'' }}">
                                <div class="wrapper">
                                   <div class="block">
                                   <img alt="dadreeios.com" class = "cloudzoom" src = "{{ asset('backend-assets/uploads/product_images_original/') }}/{{ $product_image->image_name }}"
 data-cloudzoom = "zoomImage: '{{ asset('backend-assets/uploads/product_images_original/') }}/{{ $product_image->image_name }}', touchStartDelay: 250" />
            ...
            <div class=" col-lg-6 ">
              ...
              <div class="row product-details-info">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <p id="product_sub_title" style="margin-bottom: 0.5rem;color: #4f5362;font-size: 18px !important;">{{ $product->brands->brand_name }}</p>
                    @else &nbsp;
                    @endif
                 ...
                 <div class="row">
                    <div class="col-md-6">
                       <div class="star-border">
                         ...
                         <p style="padding-left: 20px;padding-right: 20px;text-align: center;"><span>{{floor($avgrates)}} </span>Based <span>on {{$countReviews}} Customer Reviews</span></p>
                       </div>
                    </div>
                    <div class="col-md-7">
                    </div>
