               ...
               <div id="carousel-thumb" class="carousel  carousel-fade carousel-thumbnails">
                  ...
                  <div class="carousel-inner" role="listbox" id="carousel_thumbs_div">
                     ...
                     <div class="carousel-item {{ ($slidcount==0)?'active':'' }}">
                        <div class="wrapper">
                           <div class="block">
                              <img alt="dadreeios.com" id="cloudZoom" class="cloudzoom" src="{{ asset('backend-assets/uploads/product_images_original/') }}/{{ $product_image->image_name }}" data-cloudzoom="startMagnification: 8, minMagnification: 1, maxMagnification: 'auto', zoomSizeMode: 'lens',  
                  ...
                  <div class="produt-list" id="carousel_div">
                     ...
                     <ul class="carousel-indicators2">
                        ...
                        <li data-target="#carousel-thumb " class="{{ ($thumbcount==0 || $thumbcount==3)?'image-mb':'' }} {{ ($thumbcount==2 || $thumbcount==5)?'image-mt':'' }} img-li {{ ($thumbcount==0)?'active':'' }}" data-slide-to="{{ $thumbcount }}">
                           <img alt="dadreeios.com" class="img-fluid {{ ($thumbcount==0)?'active1':'' }} img-hover-shadow lazy" src="{{ asset('backend-assets/uploads/product_images_original/') }}/{{ $product_image->image_name }}">
                        </li>
      ...
      <div class=" col-lg-6 ">
         ...
         <div class="row product-details-info">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               ...
               <p id="product_sub_title" style="margin-bottom: 0.5rem;color: #4f5362;font-size: 18px !important;">{{
               ...
               <p class="pro-price-details pro-price-details price-details-text mb-1">
                  ...
                  <span id="product_discounted_price" class="price mr-2">₹ {{ $product->product_discounted_price
                     }}</span>
                  M.R.P. <span id="product_price" class="mrp-cut mr-2">₹ {{ $product->product_price }}</span>
                  ...
                  @endif
                  @if($product->product_discount_type!=null && $product->product_discount_type=='percent' &&
                  ...
                  @elseif($product->product_discount_type!=null && $product->product_discount_type=='flat' &&
                  $product->product_discount!=0)
                  <span class="discount" id="discount_flat_per">(₹ {{$product->product_discount}} OFF)</span>
                  <span class="save-amount" id="save_amount">| You Save ₹ {{
                     $product->product_price-$product->product_discounted_price }}</span>
               ...
               <form class="color-size-selected" action="{{ url('/cart/addtocart')}}" method="post">
                     ...
                     <div class="swatch clearfix" data-option-index="1">
                        ...
                        <div data-value="{{ $product->color_id }}" class="swatch-element color blue available">
                           ...
                           <label for="color-{{ $product->color_id }}" style="border-color: #000;">
                              ...
                              <img alt="dadreeios.com" height="20" width="20" style="margin: 0px 0px 0px 0px !important;" src="{{ asset('backend-assets/uploads/color_code/') }}/{{ isset($color_list[$product->color_id])?$color_list[$product->color_id]:'' }}" alt="Color">
                              @else
                              <span style="background-color: {{ isset($color_list[$product->color_id])?$color_list[$product->color_id]:'' }}; border: 1px solid black;"></span>
                              @endif
                        ...
                        @php
                        $product_color_ids = array_unique(array_column($product->product_variants->toArray(),
                        'color_id'));
                  ...
                  <div class="row product-details-info ">
                     <div class="  col-sm-5 col-7">
                        <div class="produt-details-headings colors-option-padd">
                           <p class="p-0">SELECT SIZE <span class="left-product" id="product_qty">@if($product->product_qty<=0)Out Of Stock @else Only {{ $product->
                                    product_qty?$product->product_qty:0 }} Left @endif</span>
                           </p>
                                          ...
                                          <div class="col-md-12">
                                             <div class="sizechart-section">
                                                <ul class="nav nav-tabs  nav-justified">
                                                   <li class="nav-item">
                                                      <a class="nav-link active" data-toggle="tab" href="#sizechart-table-in">
                                                   ...
                                                   <li class="nav-item">
                                                      <a class="nav-link" data-toggle="tab" href="#sizechart-img">How to
                                                         Measure</a>
                                                   </li>
                                                </ul>
                                                <!-- Tab panes -->
                                                <div class="tab-content">
                                                   <div class="tab-pane container pt-3 active  pr-0 pl-0 contain-full" id="sizechart-table-in">
                                                      <div class="table-responsive modal-size-chart">
                                                         <table class="table table-hover sizechart-style table-bordered">
                                                            ...
                                                            <tbody>
                                                               @if(isset($size_chart->chart_childs) &&
                                                               count($size_chart->chart_childs)>0)

                                                               @foreach($size_chart->chart_childs as $size_chart_child)
                                                               <tr>
                                                                  @if(isset($size_chart_types))
                                                                  <td>{{
                                                                     isset($size_chart_child->size->size_name)?$size_chart_child->size->size_name:''
                                                                     }}</td>
                                                                  @foreach ($size_chart_types as $size_chart_type)
                                                                  <td>{{
                                                                     $size_chart_child->{$size_chart_type->size_chart_field_code}
                                                                     }}</td>
                                                                  @endforeach
                                                                  @endif
                                                               </tr>
                                                         ...
                                                         <table class="table table-hover sizechart-style table-bordered">
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  @foreach ($size_chart_types as $size_chart_type)
                                                                  <td>{{
                                                                     isset($size_chart_child->{$size_chart_type->size_chart_field_code})?is_numeric($size_chart_child->{$size_chart_type->size_chart_field_code})?$size_chart_child->{$size_chart_type->size_chart_field_code}*2.54:$size_chart_child->{$size_chart_type->size_chart_field_code}:'-'
                                                                     }}</td>
                                                                  @endforeach
                                                                  @endif
                                                               </tr>
                                                   ...
                                                   <div class="tab-pane container text-center fade" id="sizechart-img">
                                                      @if(isset($size_chart->chart_images) &&
                                                      count($size_chart->chart_images)>0)
                                                      @foreach($size_chart->chart_images as $size_chart_image)
                                                      <img alt="dadreeios.com" class="img-fluid mt-3  mb-3 lazy" src="{{ asset('backend-assets/uploads/size_chart_images/') }}/{{ $size_chart_image->image_name }}" alt="">
                                                      @endforeach
                                                      @endif
                                                   </div>
                                                </div>
                              ...
                              <div class="details-color-selected">
                                 ...
                                 <div class="swatches">
                                    <div class="swatch clearfix" data-option-index="0" id="sizes_div">
                                       ...
                                       @php
                                       $product_size_ids =
                                       array_unique(array_column($product->product_variants->toArray(), 'size_id'));
                                       //dd(array_unique($product_size_ids));
                                       @endphp
                  ...
                  <div class="row product-details-info pt-4">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="product-details-addbtn">
                           ...
                           <button type="submit" name="addto" class="pro-details-btn pro-add" value="addtocart">ADD TO
                              CART</button>
                           <button class="pro-like addtowishlist" type="button" name="button"><i class="fa fa-heart heart" aria-hidden="true"></i></button>
                           <button type="submit" class="pro-details-btn  pro-buy" name="addto" value="addtobuy">BUY
                              NOW</button>
   ...
   <div class="row product-description-row">
      <div class="col-lg-6 product-description-col">
         <div class="pro-details-tabs">
            ...
            <div class="tab-content" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="nav-specificatios-tab" role="tabpanel" aria-labelledby="nav-specificatios">
                  ...
                  <div class="tab-content-color pt-4">
                     <p><span class="tab-content-specificatios">Generic Name:</span> <span class="">{{
                           $product->product_generic_name }}</span><br>
                        <span class="tab-content-specificatios">Product ID:</span> <span class="">{{
                           $product->product_sku }}</span><br>
                        <span class="tab-content-specificatios">Country of Origin:</span> <span class="">{{
                           ($product->country)?$product->country->name:'NA' }}</span><br>
                     </p>
                     <p>
                        <span class="tab-content-specificatios">Sold by: </span><span class="">{{
                           ($product->seller)?$product->seller->seller_name:'NA' }}</span><br>
                     </p>
                  ...
                  <div id="text" class="tab-content-table more-info-bg pt-4">
                     <p><span class="tab-content-details">Manufacturer Details</span><br>
                        <span class="tab-content-subdetails">{{
                           ($product->manufacturer)?$product->manufacturer->manufacturer_name:'NA' }}<br>
                     ...
                     <p><span class="tab-content-details">Packer Details</span><br>
                        <span class="tab-content-subdetails">{{ ($product->packer)?$product->packer->packer_name:'NA'
                           }}<br>
                           {{ ($product->packer)?$product->packer->packer_address:'NA' }}</span>
                     </p>
                     <p><span class="tab-content-details">Importer Details</span><br>
                        <span class="tab-content-subdetails">{{
                           ($product->importer)?$product->importer->importer_name:'NA' }}<br>
               ...
               <div class="tab-pane fade" id="nav-rating-tab" role="tabpanel" aria-labelledby="nav-rating">
                  <div class="product-details-rating">
                     <p class="rating-head">Customer Ratings & Reviews |
                        @auth
                        <a href="#" class="rating-star" data-toggle="modal" data-target="#reviewRating"> Write your
                                    ...
                                    <div class="row content-ratinng">
                                       <div class="col-lg-2 col-md-2 col-sm-5 col-5">
                                          <div class="produtct-rating-img">
                                             <img alt="dadreeios.com" class="img-fluid lazy" src="{{ asset('backend-assets/uploads/product_thumbs/'.$product->product_thumb) }}" alt="Banner">
                                          </div>
                                       </div>
                                    ...
                                    <div class="row ">
                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                          <form class="pt-4 rating-review-form" action="{{route('reviews')}}" method="post">
                                             ...
                                             <p>Write your Review and share your experience with other people<span class="star">*</span></p>
                                             <div class="form-group pb-2">
                     ...
                     <div class="col-md-6">
                        <div class="star-border">
                           <div class="star-content">
                              @if(floor($avgrates)==0 && floor($avgrates)<1) <div class="star-rating star-rating1 ">
                                 <span>☆</span><span>☆</span><span>☆</span><span>☆</span><span>☆</span>
                                 <div class="star-rating__current">
                                 </div>
                           </div>
                           @elseif(floor($avgrates)==1 && floor($avgrates)<2) <div class="star-rating star-rating1 ">
                              <span>☆</span><span>☆</span><span>☆</span><span>☆</span><span>☆</span>
                              <div class="star-rating__current">
                                 <span>★</span>
                              </div>
                        </div>
                        @elseif(floor($avgrates)==2 && floor($avgrates)<3) <div class="star-rating star-rating1 ">
                           <span>☆</span><span>☆</span><span>☆</span><span>☆</span><span>☆</span>
                           <div class="star-rating__current">
                              <span>★</span><span>★</span>
                           </div>
                     </div>
                     @elseif(floor($avgrates)==3 && floor($avgrates)<4) <div class="star-rating star-rating1 ">
                        <span>☆</span><span>☆</span><span>☆</span><span>☆</span><span>☆</span>
                        <div class="star-rating__current">
                           <span>★</span><span>★</span><span>★</span>
                        </div>
                  </div>
                  @elseif(floor($avgrates)==4 && floor($avgrates)<5) <div class="star-rating star-rating1 ">
                     <span>☆</span><span>☆</span><span>☆</span><span>☆</span><span>☆</span>
                     <div class="star-rating__current">
            ...
            <p style="padding-left: 20px;padding-right: 20px;text-align: center;"><span>{{floor($avgrates)}}
               </span>Based <span>on {{$countReviews}} Customer Reviews</span></p>
         </div>
      </div>
      <div class="col-md-7">
      </div>
   ...
   <div class="row pt-4">
      <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
         ...
         <div class="review_bttn">
            <a href="{{ url('dp/') }}/{{ $product->category_slug }}/{{ $product->sub_category_slug }}/{{ $product->sub_sub_category_slug }}/{{ $product->product_slug }}/product-reviews">See
               All Reviews</a>
         </div>
         @endif
      </div>
            ...
            <table>
               ...
               <tr id="order_now_show" style="display:none;">
                  ...
                  <td>
                     ...
                     $today = date('d-m-Y');
                     $no_of_days =
                     ($order_delivery->order_delivery_max_days>0)?$order_delivery->order_delivery_max_days:7;
   ...
   <div class="row product-details-info no-top-padd pt-4">
      <div class="col-md-12 col-12">
         ...
         <div class="social-media-icon">
            <a class="product-share fb" id="fb_share" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <!--<a class="product-share insta" href="https://www.instagram.com/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>-->
            <a class="product-share twit" id="twit_share" href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            ...
            <a class="product-share whtsp" id="whatsapp_share" href="#"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
         </div>
      </div>
   </div>
...
<script>
   ...
   $(document).ready(function() {
      ...
      } else if (isset($product->product_images) && count($product->product_images) > 0) {
      ...
      $('#pint_share').on('click', function() {
         ...
         window.open('http://pinterest.com/pin/create/button/?url=' + encodeURIComponent(u) + '&description=' + encodeURIComponent(t) + '&media=' + encodeURIComponent(sharer_image) + '', 'sharer', windowFeatures);
         return false;
      });
      $('#twit_share').on('click', function() {
         ...
         topPosition = (window.screen.height / 2) - ((height / 2) + 50);
         var windowFeatures = "status=no,height=" + height + ",width=" + width + ",resizable=yes,left=" + leftPosition + ",top=" + topPosition + ",screenX=" + leftPosition + ",screenY=" + topPosition + ",toolbar=no,menubar=no,scrollbars=no,location=no,directories=no";
         window.open('http://twitter.com/share?url=' + encodeURIComponent(u) + '&text=' + encodeURIComponent(t) + '&via=' + encodeURIComponent(siteurl) + '', 'sharer', windowFeatures);
         return false;
      });
      $('#fb_share').on('click', function() {
         ...
         window.open('https://www.facebook.com/dialog/share?app_id=795786888261296&href=' + encodeURIComponent(u) + '&t=' + encodeURIComponent(t) + '&description=' + encodeURIComponent(d) + '&picture=' + encodeURIComponent(sharer_image) + '', 'sharer', windowFeatures);
         return false;
      });
      $('#whatsapp_share').on('click', function() {
         ...
         window.open('https://api.whatsapp.com/send?text=' + encodeURIComponent(u) + '', 'sharer', windowFeatures);
         return false;
      });
