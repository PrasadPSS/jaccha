                 ...
                 <section>
                  ...
                  <div class="row">
                    <div class="col-md-7" id="content_prod">
                      ...
                      {!! !empty($content_prod->contents)?$content_prod->contents:"" !!}
                    </div>
                    <section class="mt-2"><p id="btn" class="view_more_btn"></p></section>
                    </div>
                    
      
                    <div class="col-md-5">
                      {{-- {{dd($product_listing_title)}} --}}
                    ...
                    <p style="font-size:12px;">This Data was Last Updated on {!! !empty($content_prod->content_date)?date('F d, Y', strtotime($content_prod->content_date)):"" !!}</p>
                @endif
                    </div>
                  </div>
                 </section>
