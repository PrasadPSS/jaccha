          ...
          <div class="col-md-5">
            ...
            <table class="table table-bordered " style="font-size:12px">
              ...
              <tbody>
                ...
                <tr>
                  <td  style="color:red!important"><a href="{{ url('dp/') }}/{{ $class->category_slug }}/{{ $class->sub_category_slug }}/{{ $class->sub_sub_category_slug }}/{{ $class->product_slug }}" target="_blank" style="color:red;">{{$class->product_title}}</a></td>
