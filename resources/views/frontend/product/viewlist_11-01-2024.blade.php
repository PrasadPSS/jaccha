...
<div class="container-fluidcustom top-padding ">
  ...
  <div class="row sortyby-section no-gutters sidebar-sortby">
    ...
    <div class="col-lg-10 col-sm-12 col-md-12 col-12 ">
      ...
      @if($search_flag)
      <h4 id="page_title_count_search">Search Result for <!-- : --> "{!!$search!!}"<span class="product-count" id="product-count"> ( {{$product_count}} @if($product_count>1) Items @else Item @endif))</span></h4>
      @else
      <h1 id="page_title_count">{!!$search!!}<span class="product-count" id="product-count"> ( {{$product_count}} @if($product_count>1) Items @else Item @endif)</span></h1>
      @endif
      @endif
    </div>
          ...
          <div class="col-md-5">
            ...
            <table class="table table-bordered " style="font-size:12px">
              ...
              <tbody>
                ...
                <tr>
                  <td  style="#c00000 !important"><a href="{{ url('dp/') }}/{{ $class->category_slug }}/{{ $class->sub_category_slug }}/{{ $class->sub_sub_category_slug }}/{{ $class->product_slug }}" target="_blank" style="color:#c00000 !important;">{{$class->product_title}}</a></td>
