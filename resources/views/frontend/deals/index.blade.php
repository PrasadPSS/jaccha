  ...
  <div class="row today-deals my-auto ">
    <div class="col-lg-1 col-md-2 col-sm-2 col-4 ">
      <div class="today-timerimg">
        <img src="{{ asset('frontend-assets/images/Today\'s-special-deals-clock-image.jpg') }}" class="img-fluid" alt="">
        <!--timer-todays.jpg-->
      </div>
    </div>
...
@php
//dd($today, $specialdeals->start_date , $today , $specialdeals->end_date);
//if($today>=$specialdeals->start_date && $today <= $specialdeals->end_date)
$today = new DateTime();
$start_date = new DateTime($specialdeals->start_date);
$end_date = new DateTime($specialdeals->end_date);
@endphp
        ...
        <div class=" card ">
           <div class="container1">
            <a href="{{ url('dp/') }}/{{ $product->category_slug }}/{{ $product->sub_category_slug }}/{{ $product->sub_sub_category_slug }}/{{ $product->product_slug }}" target="_blank">
                <img class="img-fluid" src="{{ asset('backend-assets/uploads/product_images/'.(isset($imageList[$product->product_id])?$imageList[$product->product_id]:'')) }}" alt="Img">
