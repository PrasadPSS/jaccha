      ...
      <div class="row login-row pt-2"> <!-- pt-4 -->
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 my-auto">
          <div class="style-text">
            <p class="mb-0">Hurry up! A Most Stylish Celebrity Look is Waiting for you!</p>
          </div>
        </div>
    </div>
          ...
          <div class="using-box">
              ...
              <form class="registration-form form-field" action="{{ url('register') }}" method="POST" onsubmit="return myRegistration()">
                ...
                <div class="input-wrapper">
                  <input class="form-control form-control-h" type="text" name="name" value="{{ old('name') }}" required pattern="[A-Za-z\s]+">
                ...
                <div style="display:none;">
                    <label for="honey_pot_validation">Leave this field empty:</label>
                    <input type="text" id="honey_pot_validation" name="honey_pot_validation">
                </div>
            <div class="form-group col-md-12 pt-3 terms-conditions-size">
              <p class="m-0">We will send you a verification code to verify your mobile phone number.</p>
              <p class="m-0 pd-bt"><i class="fa fa-info" aria-hidden="true"></i> Message and Data rates may apply.</p>
            </div>
      ...
      <div class="col-md-6 col-sm-12 col-12" >
            @if(isset($signup_image->image_url))
              <a href="{{ $signup_image->url }}">
                <img class="w-100 h-100 img-responsive login-img" src="{{ asset('backend-assets/uploads/frontend_images/') }}/{{ $signup_image->image_url }}" alt="Img">
              </a>  
            @else
              <a href="#">
              <img class="img-fluid img-responsive w-100 h-100 regi-img" src="{{ asset('frontend-assets/images/banner5.jpg') }}" alt="Img">
              </a>
            @endif
