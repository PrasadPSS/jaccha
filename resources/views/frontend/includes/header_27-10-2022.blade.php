		...
		<div class="col-lg-2 col-md-6 col-sm-6 col-12 left-pad-adj15">
			<a class="navbar-brand" href="{{ url('/') }}">
				@if(isset($logo->image_url))
					<img class="img-fluid" src="{{ asset('backend-assets/uploads/frontend_images/') }}/{{ $logo->image_url }}" alt="">
				@else
					<img class="img-fluid" src="{{ asset('frontend-assets/images/logoparwani.png') }}" alt="">
				@endif
			</a>
