...
<title>Online Shopping Site -  Shop Women & Men Fashion Clothing Online in India - {{ config('app.name', 'Dadreeios') }}</title>
...
<script type="text/javascript" src=" {{ asset('frontend-assets/js/registration-pass-hideshow.js') }}"></script>
