...
<!--footer start-->
<footer>
    @if(url()->current() == "https://www.dadreeios.com" || url()->current() == "http://www.dadreeios.com" || url()->current() == "https://dadreeios.com" || url()->current() == "http://dadreeios.com")
	...
	<div class="container-fluidcustom pt-1">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 px-0">
				<div class="">
					<h3 class="heading-underline" style="font-size:18px!important">
			...
			<div class="row row-bg w-100 pt-4 ">
					...
					<div class="col-lg-8 col-md-12 col-sm-12 col-12 align-self-end justify-content-center  pb-4">
						<section class="mar">
							<div class="footer-header">
								{{-- <h4>Most Trusted Payment Methods</h4> --}}
								<p class="heading-underline-deals">Most Trusted Payment Methods</p>
							</div>
