      ...
      @php $adcnt = 1; @endphp
        @foreach($homepagesection->section_childs as $section_child)
					@if(isset($section_child->home_page_section_child_images))
						<div class="img-height1 mt-4 ads-mobile-spacing-adjustment section-img {{ ($adcnt==2 || $adcnt==6)?'pt-2 mt-4':'' }} {{ ($adcnt==4)?' ads-red-img':'' }}" style="">
					...
					@else
						...
						<div class="img-height2 section-img">
							<iframe class=" youtube w-100" src="https://www.youtube.com/embed/{{ $videoId }}" title="Dadreeios" allowfullscreen></iframe>
						</div>
					@endif
					@if($adcnt%2 == 0)
						</div>
