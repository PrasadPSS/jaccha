        ...
        <div class="account-right-content">
          ...
          <div class="order_boxes">
            <div class="order_heading">
              ...
              <p>Ordered Placed Date : <b>{new Date(orders.created_at).getDate() + '-' + new Date(orders.created_at).getMonth() + 1 + '-' + new Date(orders.created_at).getFullYear()}</b></p>
              <p>
            ...
            <div className="order_content">
              ...
              <div class="view-order-payment">
                <div class="contact_details">
                  <h3>Need Help</h3>
                  <a href="/faq/view"><i class="fal fa-exclamation-circle"></i>
                    <p>Order Issues</p>
                    <i class="ri-arrow-right-up-line ms-2"></i>
                  </a>
                  <a href="/faq/view"><i class="fal fa-box-alt"></i><p>Returns</p>
                    <i class="ri-arrow-right-up-line ms-2"></i></a>
                </div>
                <div class="contact_details">
                  <h3>Order Summary</h3>
