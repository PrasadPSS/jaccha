                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="highlight-text" data-aos="fade-up">
                            <p dangerouslySetInnerHTML={{ __html: sectionChildren[3].home_page_section_child_sub_title }}>
                        ...
                        <div className="hightlight-icon-box">
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="400">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[4].home_page_section_child_sub_title }}>
                            ...
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="600">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[5].home_page_section_child_sub_title }}>
                            ...
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="800">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[6].home_page_section_child_sub_title }}>
                            ...
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="1000">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[7].home_page_section_child_sub_title }}>
                            ...
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="1200">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[8].home_page_section_child_sub_title }}>
                            ...
                            <div className="highlight_icon" data-aos="fade-right" data-aos-delay="1400">
                                ...
                                <p dangerouslySetInnerHTML={{ __html: sectionChildren[9].home_page_section_child_sub_title }}>
