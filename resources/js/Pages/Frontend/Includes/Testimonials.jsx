            ...
            testimonials.push({
                image: asset(
                    "backend-assets/uploads/home_page_section_child_images/" +
                        element.home_page_section_child_images
                ),
                name: element.home_page_section_child_sub_title,
                comments: element.home_page_section_child_title,
                rating: parseInt(
                    element.home_page_section_child_footer_title,
                    10
                ),
            });
        }
            ...
            <div className="container">
                ...
                <div className="row pt-4">
                                                    ...
                                                    <div className="star">
                                                        {[
                                                            ...
                                                            <img
                                                                ...
                                                                alt=""
                                                                className="object-contain shrink-0 aspect-[1.12] w-[18px]"
                                                            />
                                                        ))}
                                                    </div>
                                                    <p>
                    ...
                    <div className="col-sm-2 ps-0">
                        <div
                            className="testimonial-right text-end"
                            data-aos="zoom-in-up"
                        >
                            <img
