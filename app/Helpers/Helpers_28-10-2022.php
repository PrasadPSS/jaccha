...
if (!function_exists('order_creation'))
{
  ...
  function order_creation($current_order)
  {
    ...
    // $url = "https://staging-express.delhivery.com/api/cmu/create.json";//staging
    $url = "https://track.delhivery.com/api/cmu/create.json";//live
    ...
    if (isset($current_order->orderproducts) && $current_order->orderproducts->count()>0)
    {
      ...
      foreach ($current_order->orderproducts as $item)
      {
        ...
        $final_products_desc .= ", ".$products_desc;
      ...
      $shipments .= '{
        ...
        "country":"India",
        "products_desc":"'.$final_products_desc.'",
        "add": "'.$add.'",
        "phone": "'.$phone.'",
        "payment_mode": "'.$payment_mode.'",
        "name": "'.$name.'",
