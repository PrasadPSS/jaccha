...
class MyaccountController extends Controller
{
  ...
  public function storeprofile(Request $request)
  {
    ...
    public function changepassword(Request $request)
    {
      ...
      if($user)
      {
        ...
        try
        {
          ...
          <body><div style='margin:auto;'><a href='http://dadreeios.com/'><img src='http://holyhanspariwar.com/images/holy-hans.png' width='120'></a></div>
    ...
    //added by mahesh on 02-03-2023 for recent orders as per client
    public function recentorders()
    {
      $user_id = Auth()->user()->id;
      $orders = Orders::where('user_id',$user_id)->with(['orderproducts'])->orderBy('order_id','DESC')->limit(10)->get();
      return view('frontend.orders.recentorders',compact('orders'));
      // return redirect()->to('/myaccount/profile');
    }
    ...
    public function trackorders()
    {
      $user_id = Auth()->user()->id;
      $orders = Orders::where('user_id',$user_id)->with(['orderproducts'])->orderBy('order_id','DESC')->get();
      return view('frontend.orders.track_orders',compact('orders'));
      // return redirect()->to('/myaccount/profile');
    }
