...
class PagesController extends Controller
{
    public function index($cms_pages_id)
    {
        ...
        if($page_content)
        {
            ...
            $custom_page_title = CustomPageTitles::where('custom_page_title_code','cms')->first();
            $page_title = "";
    ...
    public function contactus(Request $request)
    {
        ...
        $orders = Orders::where('orders_counter_id',$request->order_no)->first();
        if(isset($orders->orders_counter_id) && $orders->orders_counter_id == $request->order_no){
            ...
            return back()->withInput()->with('error','Invalid Order No !');
        }
        /*
        if ($constactus->save())
        {
