...
class ProductController extends Controller
{
  ...
  public function productlist(Request $request, $category_slug = null, $sub_category_slug = null, $sub_sub_category_slug = null, $sort_order = null, $search_query = null)
  {
    ...
    $content_prod = Productlist::where([
      ...
      'sub_category_id' => $assign_category_filters->sub_category_id, 'sub_sub_category_id' => $assign_category_filters->sub_sub_category_id
    ])->first();
    //  dd($assign_category_filters->toArray());
    // if(!empty($assign_category_filters->category_id) && )
    ...
    return view('frontend.product.viewlist', compact(
      'products',
      'content_prod',
      'product_list',
      'filters',
  ...
  public function productdetails($category_slug, $sub_category_slug, $sub_sub_category_slug, $product_slug)
  {
    ...
    if ($product->count() > 0) {
      ...
      if (Auth()->check()) {
        ...
        return view('frontend.product.viewproduct', compact(
          'product',
          'size_chart',
          'size_chart_types',
          'color_list',
