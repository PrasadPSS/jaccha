...
class CartController extends Controller
{
    ...
    public function paymentstatus(){
        // dd($_POST);
        $surl = url('cart/phonepepaymentsuccess');
        $furl = url('cart/phonepepaymentfailure');
        if(isset($_POST['merchantId']) && isset($_POST['transactionId']) && isset($_POST['amount']) )
        {
            ...
            $tran_id = $responsePayment['data']['merchantTransactionId'];
            ...
            if ($responsePayment['success'] && $responsePayment['code'] == "PAYMENT_SUCCESS"){
                return redirect($surl."php?tran_id=".$tran_id."&amount=".$amount);
            }else{
                return redirect($furl."php?tran_id=".$tran_id."&amount=".$amount);
            }
        }
    }
    ...
    public function phonepepaymentsuccess(){
        ...
        if (!($existing_payment)) {
            ...
            $payment_info->data_dump = json_encode($_GET);
