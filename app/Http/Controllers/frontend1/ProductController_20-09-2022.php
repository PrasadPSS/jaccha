...
class ProductController extends Controller
{
    ...
    public function productlist(Request $request,$category_slug=null,$sub_category_slug=null,$sub_sub_category_slug=null,$sort_order=null,$search_query=null)
    {
      ...
      return view('frontend.product.viewlist',compact('products','filters','size_list',
      'category_slug','sub_category_slug','sub_sub_category_slug','sort_order','sort_by_options',
      'filter_values_ids','search','search_flag','breadcrumb','filter_level','product_count','search_query','product_listing_title'));
    }
      ...
      if ($product->count()>0)
      {
        ...
        if(Auth()->check())
        {
          ...
          return view('frontend.product.viewproduct',compact('product','size_chart','size_chart_types','color_list','reviews','countReviews','avgrates','calstar','percentage',
              'relatedProducts','imageList','twoReviews','frequently_boughts','frequently_bought_image','recentlyViews','recentlyViewsimage','size_list','coupon_data','order_delivery','breadcrumb','product_details_title'));
        }
        return view('frontend.product.viewproduct',compact('product','size_chart','size_chart_types','color_list','reviews','countReviews','avgrates','calstar','percentage',
            'relatedProducts','imageList','twoReviews','frequently_boughts','frequently_bought_image','size_list','coupon_data','order_delivery','breadcrumb','product_details_title'));
      }
      else
      {
        return redirect('/');
