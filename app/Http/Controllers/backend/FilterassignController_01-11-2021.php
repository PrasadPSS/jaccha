...
class FilterassignController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index($id)
    {
      ...
      // dd($has_permissions);
      return view('backend.filterassign.index',compact('filter_id','filter','filterassign'));
    }
    ...
    public function edit($id)
    {
        ...
        // dd($has_permissions);
        return view('backend.filterassign.edit',compact('filter_value','categories','sub_categories','sub_sub_categories'));
