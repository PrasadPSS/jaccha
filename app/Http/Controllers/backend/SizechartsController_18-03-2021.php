...
class SizechartsController extends Controller
{
  public function __construct()
  {
    ...
    public function show($id)
    {
        ...
        return view('backend.sizecharts.show', compact('sizecharts'));
    }
    ...
    public function edit($id)
    {
        ...
        // dd($sizechart_childs);
        return view('backend.sizecharts.edit', compact('sizecharts','sizes','sizechart_childs','size_chart_images'));
    }
    ...
    public function getsizechartchilds(Request $request)
    {
      ...
      $returnArr = ['flag'=>$child_flag,'table'=>$sizechartchilds,'remove'=>$remove_child_ids];
