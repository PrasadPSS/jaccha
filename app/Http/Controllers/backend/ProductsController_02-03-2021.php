...
class ProductsController extends Controller
{
  public function __construct()
  {
    ...
    public function create()
    {
      ...
      return view('backend.products.create', compact('categories','sub_categories','sub_sub_categories','countries','sellers','manufacturers','packers','importers','filter_list','color_list','size_list'));
    }
    ...
    public function edit($id)
    {
        ...
        // dd($filter_list);
        return view('backend.products.edit', compact('products','categories','sub_categories','sub_sub_categories','countries','sellers','manufacturers','packers','importers','product_images','filter_list','filter_values','color_list','size_list','product_variants'));
    }
