...
class CodmanagementController extends Controller
{
  ...
  public function update(Request $request)
  {
    ...
    $cod_management->fill($request->all());
    $cgst_amount = ($request->cod_collection_charge*$request->cod_cgst_percent)/100;
    $cod_management->cod_cgst_amount = $cgst_amount;
    $sgst_amount = ($request->cod_collection_charge*$request->cod_sgst_percent)/100;
    $cod_management->cod_sgst_amount = $sgst_amount;
    $igst_amount = ($request->cod_collection_charge*$request->cod_igst_percent)/100;
    $cod_management->cod_igst_amount = $igst_amount;
