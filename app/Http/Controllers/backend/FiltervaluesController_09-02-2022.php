...
class FiltervaluesController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index($id)
    {
      ...
      // dd($has_permissions);
      return view('backend.filtervalues.index',compact('filter_id','filter','filtervalues','colors','filter_type'));
    }
    ...
    public function create($id)
    {
      ...
      return view('backend.filtervalues.create',compact('filter_id','filter','sizes','colors','filter_type'));
        // exit;
    }
    ...
    public function edit($id)
    {
        ...
        // dd($has_permissions);
        return view('backend.filtervalues.edit',compact('filter_value','sizes','colors','filter_type'));
