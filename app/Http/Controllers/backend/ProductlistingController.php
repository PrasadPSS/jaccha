...
class ProductlistingController extends Controller
{
  ...
  public function first_level_edit($id)
  {
    ...
    $filters = Productlist::where(['category_id'=> $id,'sub_category_id'=>null,'sub_sub_category_id'=>null])->first();
  ...
  public function second_level_edit($id, $sub_id)
  {
    ...
    $filters = Productlist::where(['category_id'=> $id,'sub_category_id'=>$sub_id,'sub_sub_category_id'=>null])->first();
