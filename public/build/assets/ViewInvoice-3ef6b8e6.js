import{j as e}from"./app-dacddda1.js";const d=()=>{const{orderId:a}=new URLSearchParams,r=c=>{const i=document.querySelector(c).innerHTML,s=window.open("","Print Invoice","height=600,width=800");s.document.write("<html><head><title>Print Invoice</title>"),s.document.write(`
      <style>
        body {
