import{j as e}from"./app-9c60c081.js";const d=()=>{const{orderId:a}=new URLSearchParams,r=c=>{const i=document.querySelector(c).innerHTML,s=window.open("","Print Invoice","height=600,width=800");s.document.write("<html><head><title>Print Invoice</title>"),s.document.write(`
      <style>
        body {
