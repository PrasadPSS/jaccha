import{j as e}from"./app-7b200f12.js";const l=()=>{const{orderId:a}=new URLSearchParams;console.log(a);const r=c=>{const n=document.querySelector(c).innerHTML,s=window.open("","Print Invoice","height=600,width=800");s.document.write("<html><head><title>Print Invoice</title>"),s.document.write(`
      <style>
        body {
